...
<body>
    ...
    <div class="email-container">
        <div class="content">
            ...
            <p>We hope you had a seamless experience with VendorsCity for your {{ $subserviceName }} booking. If you haven't already, you can rate your experience <a href="{{ url('/') }}">here</a>.</p>
