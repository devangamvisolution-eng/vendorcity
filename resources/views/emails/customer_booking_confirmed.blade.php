...
<body>
    ...
    <div class="email-container">
        <div class="content">
            ...
            <p>Your booking is confirmed and will be carried out on {{ $dateTime }}.</p>

            <p>If you need to change your booking please do so at least 6 hours before the job to avoid late
                cancellation fees. You can easily make changes to your booking using our <a
                    href="{{ route('order-detail', ['city' => strtolower(str_replace(' ', '-', $firstItem->city ?? 'dubai')), 'id' => $orderdata->order_id]) }}">website</a>.
                You
                can also review our cancellation policy <a
                    href="{{ route('cancellations_policy', ['city' => strtolower(str_replace(' ', '-', $firstItem->city ?? 'dubai'))]) }}">here</a>.
            </p>
            ...
            <table class="payment-table">
                <tr>
                    ...
                    <td class="value">AED
                        {{ number_format($orderdata->sub_total, 2) }}
                    </td>
                </tr>
                <tr>
