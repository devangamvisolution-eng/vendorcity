            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Package Order - Car Inspection</li> 
              ...
              @if (in_array('40', $edit_perm) || in_array('19', $edit_perm) || in_array('44', $edit_perm) || in_array('45', $edit_perm) || in_array('42', $edit_perm))
               <div class="col-auto">
                ...
                @if(Route::currentRouteName() == 'car-inspection-order')
                    <a class="btn btn-primary me-1" href="{{ route('car-inspection-admin-order') }}">
                        <i class="fas fa-plus"></i> Add Car Inspection Order
                    </a>
                @endif
                </div>
             @endif
                                    ...
                                    <tbody>
                                        ...
                                        @if(!empty($orders->items))
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if(Route::currentRouteName() == 'car-inspection-order'){
                                                        ...
                                                        $year = $orders->items[0]->bookingyear ?? "";
                                                         ...
                                                         $inspection_date = $month.' '.$date.', '.$year;
                                                ...
                                                <td>
                                                    ...
                                                    <option value="P" {{ $orders->order_status === 'P' ? 'selected' : '' }}>Confirmed</option>
                                        ...
                                        @endif
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    @else
                                                    <a class="btn btn-primary" href="{{ route('car-inspection-detail', [$orders->order_id]) }}"><i class="far fa-eye me-2"></i>Details</a>
                                                        @endif
                                                </td>
                                            ...
                                            @endif
                                                ...
                                                <td class="text-right">
                                                 ...
                                                 <td class="text-right">
                                                 <a class="btn btn-primary"
                                                    href="#" onclick="updatepopup('{{$orders->items[0]->end_date}}','{{$orders->items[0]->time_slot}}','{{$orders->items[0]->order_id}}');"><i
                                                        class="far fa-edit"></i></a>
                                                 </td>
                                                 <td class="text-right">
                                                     <a class="btn btn-primary"
                                                 ...
                                                 <td class="text-right">
                                                 <a class="btn btn-primary"
                                                    href="{{ route('car-inspection-order-edit', ['id' => $orders->order_id]) }}"><i
                                                        class="far fa-edit"></i></a>
                                                 </td>
                                                  @endif
                                                @endif
...
<div class="modal custom-modal fade" id="assign_vendor_model" role="dialog">
   ...
   <div class="modal custom-modal fade" id="update_popup_model" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="order_inspection_form" action="{{ url('car_inpsection_form') }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal-body">
               ...
               <div class="col-md-6">
                       <div class="form-group">
                        <label>Date</label>
                        <input type="date" name="update_inspection_date" id="update_inspection_date" class="form-control"  value="">
                    ...
                    <div class="col-md-6">
                       <div class="form-group">
                        <label>Time</label>
                        <select name="update_inspection_time" id="update_inspection_time" class="form-select">
