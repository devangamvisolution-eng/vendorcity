            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Inspection Package</li>
                    </ul>
                </div>
                @if (in_array('55', $edit_perm))
                    <div class="col-auto">
                        ...
                        <a class="btn btn-primary me-1" href="{{ route('verifybuy-packages.create') }}">
                            <i class="fas fa-plus"></i> Add Inspection Package
                        </a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_verifybuy_package') }}" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable" id="example">
                                    ...
                                    <tbody>
                                        @foreach ($verifybuypackages as $data)
                                            <tr>
                                             ...
                                             <td><img src="{{ url('public/upload/verifybuypackages/small/' . $data->image) }}"
                                                 ...
                                                 <td>
                                                    ...
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('verifybuy-packages.edit', $data->id) }}"><i
               ...
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                       ...
                       <div class="modal-text text-center">
                           ...
                           <h3>Are you sure you want to change the Status of Packages ? </h3>
        ...
        $(document).ready(function() {
           ...
           function fun_review_status() {
               ...
               $.ajax({
                   ...
                   url: "{{ url('change_status_inspection_packages') }}",
