...
<div class='content container-fluid'><div class='page-header'><div class='row align-items-center'><div class='col'><h3 class='page-title'>Add CleaningSubscriptionPackage</h3></div><div class='col-auto'><a class='btn btn-primary btn-premium' href="{{ route('cleaning-subscription-packages.index') }}">Back</a></div></div></div><div class='row'><div class='col-md-12'><div class='card premium-card'><div class='card-body'><form action="{{ route('cleaning-subscription-packages.store') }}" method='POST'>@csrf <div class='row'><div class='col-md-6 mb-3'><label>Name</label><input type='text' name='name' class='form-control' required></div><div class='col-md-6 mb-3'><label>Validity months</label><input type='number' name='validity_months' class='form-control' required></div><div class='col-md-6 mb-3'><label>Discount percentage</label><input type='number' name='discount_percentage' class='form-control' required></div>
