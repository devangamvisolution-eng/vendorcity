                    ...
                    <div class="card-body">
                        ...
                        <form id="subservice_form" action="{{ route('subservice.store') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="subservice_code" name="subservice_code" type="text"
                                            class="form-control" placeholder="Enter Sub Service Code" value="" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="promo_discount" name="promo_discount" type="text"
                                            class="form-control" placeholder="Enter Promo Discount" value="" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="banner_subtitle" name="banner_subtitle" type="text"
                                            class="form-control" value="" placeholder="Enter Banner Title" />
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="display_top_dropdown"
                                            name="display_top_dropdown">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="image_alt_tag" name="image_alt_tag" type="text"
                                            class="form-control" value="" placeholder="Enter Image Alt tag" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="additional_charge_popup" name="additional_charge_popup" type="text" class="form-control"
                                            placeholder="Enter Additional Charge Discription" value="" /></textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="timing_fee_popup" name="timing_fee_popup" type="text" class="form-control"
                                            placeholder="Enter Timing Fee Discription" value="" /></textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="delivery_charge_popup" name="delivery_charge_popup" type="text" class="form-control"
                                            placeholder="Enter Delivery Charge Discription" value="" /></textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="service_fee_popup" name="service_fee_popup" type="text" class="form-control"
                                            placeholder="Enter Service Fee Popup Discription" value="" /></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group"> <label for="categoryname">City</label>
                                        <select class="form-control" id="city_addmore_why_choose"
                                            name="city_addmore_why_choose[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}">{{ $data->name }}
                                                </option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button
                                        ...
                                        class="submit btn bg-purple pull-right" type="button"
                                        id="add_field_button_why_choose">Add
                                        More </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group"> <label for="categoryname">City</label>
                                        <select class="form-control" id="city_addmore_description"
                                            name="city_addmore_description[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}">{{ $data->name }}
                                                </option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button
                                        style="border: medium none;margin-right: 15px;line-height: 25px; margin-top: 10px; margin-bottom: 20px;"
                                        class="submit btn bg-purple pull-right" type="button"
                                        id="add_field_button_description">Add
                                        More </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group"> <label for="categoryname">City</label>
                                        <select class="form-control" id="city_addmore_more_service"
                                            name="city_addmore_more_service[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}">{{ $data->name }}
                                                </option>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group"><label for="categoryname">Subservices</label>
                                        <select class="form-control select2" id="subservice_addmore_more_service_0"
                                            name="subservice_addmore_more_service[0][]" multiple="multiple"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button
                                        style="border: medium none;margin-right: 15px;line-height: 25px; margin-top: 10px; margin-bottom: 20px;"
                                        class="submit btn bg-purple pull-right" type="button"
                                        id="add_field_button_more_service">Add
                                        More </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group"> <label for="categoryname">City</label>
                                        <select class="form-control" id="city_addmore_what_else_service"
                                            name="city_addmore_what_else_service[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}">{{ $data->name }}
                                                </option>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group"><label for="categoryname">Subservices</label>
                                        <select class="form-control select2" id="subservice_addmore_what_else_service_0"
                                            name="subservice_addmore_what_else_service[0][]" multiple="multiple"
                                            data-placeholder="Select Subservices" style="width: 100%;">
                                            @foreach ($all_subservices as $data)
                                                <option value="{{ $data->id }}">{{ $data->subservicename }}
                                                </option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button
                                        style="border: medium none;margin-right: 15px;line-height: 25px; margin-top: 10px; margin-bottom: 20px;"
                                        class="submit btn bg-purple pull-right" type="button"
                                        id="add_field_button_what_else_service">Add
                                        More </button>
                                </div>
                            </div>
                            ...
                            @for ($i = 1; $i <= 4; $i++)
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group"> <label for="step_{{ $i }}_title">Step
                                                {{ $i }} Title</label>
                                            <input type="text" id="step_{{ $i }}_title"
                                                name="step_{{ $i }}_title" class="form-control"
                                                placeholder="Enter Step {{ $i }} Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group"> <label for="step_{{ $i }}_image">Step
                                                {{ $i }} Image</label>
                                            <input type="file" id="step_{{ $i }}_image"
                                                name="step_{{ $i }}_image" class="form-control"
                                                placeholder="">
                                        </div>
                                    </div>
                                </div>
            ...
            $(add_button).click(function(e) {
                ...
                if (b < max_fields) {
                    ...
                    var newField = $(
                        ...
                        b +
                        '" name="whychoosevc_addmore[]" class="form-control" placeholder="Enter Description"></textarea></div></div><a href="#" class="btn btn-danger pull-right remove_field_why_choose" style="margin-right: 0;margin-top: 23px;width: 10%;float: right;height: 38px;margin-left: 30px;">Remove</a></div>'
                    );
            ...
            $(add_button).click(function(e) {
                ...
                if (b < max_fields) {
                    ...
                    var newField = $(
                        ...
                        b +
                        '" name="description_addmore_new[]" class="form-control" placeholder="Enter Description"></textarea></div></div><a href="#" class="btn btn-danger pull-right remove_field_description" style="margin-right: 0;margin-top: 23px;width: 10%;float: right;height: 38px;margin-left: 30px;">Remove</a></div>'
                    );
            ...
            $(add_button).click(function(e) {
                ...
                if (b < max_fields) {
                    ...
                    var newField = $(
                        ...
                        b + '" name="subservice_addmore_more_service[' + b +
        ...
        $(document).ready(function() {
            ...
            $(add_button).click(function(e) {
                ...
                if (b < max_fields) {
                    b++;
                    var newField = $(
                        '<div class="row"><hr><div class="col-md-4"><div class="form-group"> <label for="categoryname">City</label><select class="form-control" name="city_addmore_what_else_service[]"><option value="">Select City</option>@foreach ($allcity as $data)<option value="{{ $data->id }}">{{ $data->name }}</option>@endforeach</select></div></div><div class="col-md-8"><div class="form-group"><label for="categoryname">Subservices</label><select class="form-control select2" id="subservice_addmore_what_else_service_' +
                        b + '" name="subservice_addmore_what_else_service[' + b +
