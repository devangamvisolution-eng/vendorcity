                ...
                <input type="hidden" name="total_amount" id="total_amount" value="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="pacakge_id" name="pacakge_id" class="form-control form-select" onchange="showpackage
                                        (this.value);">
                            ...
                            <option value="Fujairah" data-id="26">Fujairah</option>
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input name="inspection_date" type="date" class="form-control " id="inspection_date" placeholder="Address">
