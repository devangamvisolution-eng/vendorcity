                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if ($subservice->app_icon != '')
                                            <img src="{{ asset('public/upload/subservice/app_icon/' . $subservice->app_icon) }}"
                                                style="width: 50px; margin-top: 10px;" />
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="display_top_dropdown"
                                            ...
                                            <option value="1" @if ($subservice->display_top_dropdown == 1) selected @endif>Yes
                                            </option>
                                            <option value="0" @if ($subservice->display_top_dropdown == 0) selected @endif>No
                                            </option>
                                        </select>
                                    </div>
                                </div>
