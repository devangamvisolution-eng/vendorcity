...
<div class="content container-fluid">
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Package Order - Survey Order</h3>
            ...
            <div class="col-auto">
                <a class="btn btn-primary" href="{{ route('survey-orders.create') }}">
                    <i class="fas fa-plus me-1"></i> Add Survey Order
                </a>
            </div>
            @endif
        </div>
        ...
        <div class="card-body p-4">
            <table class="action-table" id="example">
                ...
                <tbody>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end shadow border-0">
                                            ...
                                            <a class="dropdown-item py-2"
                                                href="{{ route('survey-orders.edit', $order->order_id) }}">
                                                <i class="fas fa-edit text-muted me-2"></i> Edit Order
                                            </a>
                                            @endif
                                            <a class="dropdown-item py-2"
                                                href="{{ route('survey-order-detail', $order->order_id) }}">
                                            ...
                                            <button type="button" class="dropdown-item py-2"
                                                onclick="add_comm_model(
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        '{{ $order->order_total }}',
                                                                                                                                                                                                                                                                                                                                                                        '{{ $order->sub_total }}',
                                                                                                                                                                                                                                                                                                                                                                        '{{ $item->subservice_booking_percentage ?? 0 }}',
                                                                                                                                                                                                                                                                                                                                                                        '{{ $item->subservice_booking_amount ?? 0 }}'
                                                                                                                                                                                                                                                                                                                                                                    )">
                                            ...
                                            <form id="delete-form-{{ $order->order_id }}"
                                                action="{{ route('survey-orders.destroy', $order->order_id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
                    ...
                    @else
                        <tr>
                            <td colspan="5" class="text-center">No Survey Orders found.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
