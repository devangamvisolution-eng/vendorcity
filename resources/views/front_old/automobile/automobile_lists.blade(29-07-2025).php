        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-xl-5 pl30-md pl15-xs wow " data-wow-delay="500ms">
			  ...
			  <p><i class="fa-solid fa-arrow-up-right-from-square" style="color: #0040E6;"></i> 
			  <a href="{{ route('automobile.packages') }}" style="text-decoration: underline;"> View Sample Inspection Report</a></p>
            ...
            <div class="col-md-6 col-xl-6 offset-xl-1 wow " data-wow-delay="500ms">
              <div class="about-img"><img class="w100" src="{{ asset('public/site/images/automobile/our_values.png') }}" alt=""></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="job-list-style1 default-box-shadow1 bdrs16  bgc-incol">
              <div class="align-items-start">
                <div class="icon d-flex align-items-center mb20">
                  <img class="wa" src="{{ asset('public/site/images/team/client-2.png') }}" alt="">
                </div>
	...
	<section class="pt60 pb60 pb30-md">
      <div class="container">
        <div class="row align-items-center wow">
          <div class="col-lg-12">
            <div class="main-title text-center">
              <h2 class="title ">Get Your Car Inspected in <span class="titlebg">4 Simple Steps.</span></h2>
            </div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="cta-banner mx-auto maxw1600 pt80 pt60-lg pb40 pb60-lg position-relative overflow-hidden mx20-lg">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 col-xl-6 offset-xl-1 wow " data-wow-delay="500ms">
              <div class="about-img"><img class="w100 bdrs30" src="{{ asset('public/site/images/automobile/our_ai.png') }}" alt=""></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="freelancer-style1 text-center bdr1 hover-box-shadow mb60 bdrs12 bg-color">
                    <div class="thumb mb25 mx-auto position-relative rounded-circle">
                      <img class="mx-auto bdrs12"  src="{{ asset('public/site/images/automobile/automobile.jpg') }}" alt="">
                    </div>
                    <div class="details cars-detail">
                      <h5 class="title mb-1 car-name">Nissan Patrol</h5>
                      <p class="mb10 car-desc">This SUV is known for it's rugged off-road capabilities , luxury</p>
                      <div class="skill-tags d-flex align-items-center mb5">
                        <span class="tag"><i class="fas fa-star fz10 review-color"></i>5/5</span>
                        <span class="tag mx5">35000 Miles</span>
                        <span class="tag">Diesel/Petrol</span>
                      </div>
                    </div>
                  </div>
          </li>
          ...
          <div class="freelancer-style1 text-center bdr1 hover-box-shadow mb60 bdrs12 bg-color">
                    ...
                    <div class="details cars-detail">
                      <h5 class="title mb-1 car-name">BMW</h5>
                      <p class="mb10 car-desc">This BMW X5 is a luxury SUV that biends powerfull</p>
                      <div class="skill-tags d-flex align-items-center mb5">
                        <span class="tag"><i class="fas fa-star fz10 review-color"></i> 3/5</span>
                        <span class="tag mx5">60000 Miles</span>
          ...
          <div class="freelancer-style1 text-center bdr1 hover-box-shadow mb60 bdrs12 bg-color">
                    ...
                    <div class="details cars-detail">
                      <h5 class="title mb-1 car-name">Cadillac</h5>
                      <p class="mb10 car-desc">Cadillac is one of the oldest and most prestigious American.</p>
                      <div class="skill-tags d-flex align-items-center mb5">
                        <span class="tag"><i class="fas fa-star fz10 review-color"></i> 5/5</span>
                        <span class="tag mx5">35000 Miles</span>
                        <span class="tag">Diesel/Petrol</span>
                ...
                <div class="accordion" id="accordionExample">
                  <div class="accordion-item active">
                    <h2 class="accordion-header" id="headingOne">
                      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Will I get my report immediately?</button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Can the car inspection be done on-site?</button>
                    </h2>
