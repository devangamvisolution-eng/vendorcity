        ...
        <div class="row main-area-cont">
                                ...
                                <div id="sofa{{ $package_cat_data->id }}" class="section-packages"
                                    ...
                                    @if ($package_cat_data->image != '')
                                        <img src="{{ url('public/upload/packagecategory/' . $package_cat_data->image) }}"
                                            alt="{{ $package_cat_data->name }}" class="w-100 rounded mb-4"
                                            style="object-fit: cover; max-height: 200px;">
                                    @endif
                                    <h4
                                        style="margin-bottom: 15px; font-weight: 800; font-size: 18px; background: #f8f9fa; color: #111; padding: 12px 16px; border-radius: 8px; border-left: 4px solid #FFD312;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-12">
                                                ...
                                                <div class="wallet-card-ui d-none promo_dicount_replace_div"
                                                    style="border-color: #16a34a; background: rgba(22, 163, 74, 0.04);">
                                                    <div style="display:flex; align-items:center; gap:12px; flex:1;">
                                                        <div class="wallet-icon-box"
                                                        ...
                                                        <div class="wallet-info">
                                                            <div class="wallet-label" style="color: #16a34a;">Coupon
                                                                Applied: <span class="promo_code_name">ABC</span></div>
                                                            <div
                                                                style="font-size:1.15rem; font-weight:900; color:#16a34a; line-height:1;">
                                                                - <span class="currency_dhiramnew"
                                                                    style="font-size:0.85rem; position:relative; top:-1px;">AED</span><span
                                                    ...
                                                    <div style="margin-left: 10px;">
                                                        <button onclick="remove_coupon();" type="button"
                                                            ...
                                                            style="display: block; background: #fff; border: 1px solid #ddd; padding: 8px 14px;">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="col-lg-4 col-md-4 sol-sm-12">
                <div class="sidebar sidebar-summary" id="rightSidebar">
                    ...
                    <div class="left-summary-total d-flex mb-4 align-items-center">
        ...
        <div class="modal-content" style="background-color: #f5f7f9; border: none; border-radius: 20px 20px 0 0;">
            ...
            <div class="modal-body tabby-modal-body"
                ...
                <div
                    ...
                    <div
                        style="text-align: right; font-weight: 700; color: #111; display: inline-flex; align-items: baseline; gap: 4px;">
                        <span class="price-wrapper">
                            <span class="currency_dhiramnew" style="font-size:0.85rem;">AED</span>
                            <span id="tabby_split_amount">0.00</span>
                        </span>/mo
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <span class="price-wrapper">
                            <span class="currency_dhiramnew" style="font-size:0.85rem;">AED</span>
                            <span id="tabby_split_amount_6">0.00</span>
                        </span>/mo
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <span class="price-wrapper">
                            <span class="currency_dhiramnew" style="font-size:0.85rem;">AED</span>
                            <span id="tabby_split_amount_8">0.00</span>
                        </span>/mo
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <span class="price-wrapper">
                            <span class="currency_dhiramnew" style="font-size:0.85rem;">AED</span>
                            <span id="tabby_split_amount_12">0.00</span>
                        </span>/mo
                    </div>
                </div>
