            ...
            <div class="column">
             <div class="summary_div_left_new">
                ...
                {{-- @if($subservice_id != 29 && $subservice_id != 70 && $subservice_id != 71 && $subservice_id != 72 &&  $subservice_id != 73 && $subservice_id != 79 && $subservice_id != 80 && $subservice_id != 81 && $subservice_id != 82 && $subservice_id != 83 && $subservice_id != 84 && $subservice_id != 85 && $subservice_id != 86 && $subservice_id != 87) --}}
                    ...
                    <stong >AED <span id="cross_amount" style="text-decoration: line-through;"></span></stong><br>
                    {{-- @endif --}}
                   </div>
                    <strong >AED <span id="total_to_pay_charge_replace"></span></strong>
                </div>
                ...
                <div class="d-flex justify-content-between subheadingdev"><div >Service Charges</div><div class="font-weight-bold sm-summary"> AED <span id="service_charge_replace">  </span></div></div>
                ...
                <div class="d-flex justify-content-between additional_charge_replace_div subheadingdev" style="display: none !important"><div>Additional Charges</div><div class="font-weight-bold sm-summary"> AED <span id="additional_charge_replace">0.00</span></div></div>
                ...
                <div class="d-flex justify-content-between subheadingdev"><div>Sub Total</div><div class="font-weight-bold sm-summary"> AED <span id="sub_total_replace">0.00</span></div></div>
                <div class="d-flex justify-content-between subheadingdev"><div>VAT (5%)</div><div class="font-weight-bold sm-summary"> AED <span id="vat_charge_replace">3.90</span></div></div>
