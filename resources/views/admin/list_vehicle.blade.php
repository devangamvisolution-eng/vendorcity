            ...
            <div class="row align-items-center">
                ...
                @if (in_array('56', $edit_perm))
                    <div class="col-auto">
                        ...
                        <a class="btn btn-primary me-1" href="{{ route('vehicle.create') }}">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_vehicle') }}" enctype="multipart/form-data">
                                        ...
                                        @foreach ($vehicles as $data)
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <td><img src="{{ url('public/upload/vehicle/small/' . $data->image) }}"
                                                           ></td>
                                                           <td>
                                                              <input type="checkbox"
                                                                id="extra_check[{{ $data->id }}]"
                                                                class="minimal-red"
                                                                style="height: 20px;width: 20px;border-radius: 0px;color: red;" 
                                                                {{ $data->show_inform == 0 ? 'checked' : '' }} 
                                                                onclick="show_inform('{{ $data->id }}', this.checked ? 0 : 1);">                                                            
                                                                
                                                           </td>
                                                @if (in_array('56', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('vehicle.edit', $data->id) }}"><i
...
<!-- set order Modal -->
    <div class="modal custom-modal fade" id="status_modell" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-text text-center">
                        <h3>Are you sure you want to Show In form?</h3>
    ...
    <script>
       ...
       function show_inform(id,val){
        // alert(id);
        // alert(val);exit;
        $('#is_active_id').val(id);
            $('#is_active_val').val(val);
