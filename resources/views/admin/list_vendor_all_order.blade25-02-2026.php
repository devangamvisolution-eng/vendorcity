                                        ...
                                        @if (isset($vendororders_list) and count($vendororders_list))
                                            @foreach ($vendororders_list as $key => $vendororders)
                                                <tr>
                                                    ...
                                                    <td>{!! isset($vendororders->items) ? Helper::servicename($vendororders->items[0]->service_id) : '-' !!}</td>
                                                    <td>{!! isset($vendororders->items[0]) ? Helper::subservicename($vendororders->items[0]->subservice_id) : '-' !!}</td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary"
                                                            href="{{ route('vendor-all-order-detail', [$vendororders->order_id]) }}"><i
