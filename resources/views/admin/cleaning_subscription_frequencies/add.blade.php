...
<div class='content container-fluid'><div class='page-header'><div class='row align-items-center'><div class='col'><h3 class='page-title'>Add CleaningSubscriptionFrequency</h3></div><div class='col-auto'><a class='btn btn-primary btn-premium' href="{{ route('cleaning-subscription-frequencies.index') }}">Back</a></div></div></div><div class='row'><div class='col-md-12'><div class='card premium-card'><div class='card-body'><form action="{{ route('cleaning-subscription-frequencies.store') }}" method='POST'>@csrf <div class='row'><div class='col-md-6 mb-3'><label>Visits per week</label><input type='number' name='visits_per_week' class='form-control' required></div><div class='col-md-6 mb-3'><label>Label</label><input type='text' name='label' class='form-control' required></div>
