...
<div class="card border-0 shadow-sm mb-5" style="border-radius: 15px; overflow: hidden; background: #fff;">
    <div class="card-header bg-white border-0 pt-4 pb-0">
        <h5 class="card-title text-dark mb-0" style="font-weight: 700; font-size: 1.25rem; letter-spacing: 0.5px;">
            <i class="fa fa-info-circle me-2" style="color: #6777ef;"></i> Basic & Other Information
        </h5>
    </div>
...
<div class="card border-0 shadow-sm mb-5" style="border-radius: 15px; overflow: hidden; background: #fff;">
    <div class="card-header bg-white border-0 pt-4 pb-0">
        <h5 class="card-title text-dark mb-0" style="font-weight: 700; font-size: 1.25rem; letter-spacing: 0.5px;">
            <i class="fa fa-image me-2" style="color: #6777ef;"></i> Banners Section
        </h5>
    </div>
...
<div class="card border-0 shadow-sm mb-5" style="border-radius: 15px; overflow: hidden; background: #fff;">
    <div class="card-header bg-white border-0 pt-4 pb-0">
        <h5 class="card-title text-dark mb-0" style="font-weight: 700; font-size: 1.25rem; letter-spacing: 0.5px;">
            <i class="fa fa-align-left me-2" style="color: #6777ef;"></i> Top Description Section
        </h5>
    </div>
    <div class="card-body p-4">
                                    <div class="col-md-12 ">
...
<div class="card border-0 shadow-sm mb-5" style="border-radius: 15px; overflow: hidden; background: #fff;">
    <div class="card-header bg-white border-0 pt-4 pb-0">
        <h5 class="card-title text-dark mb-0" style="font-weight: 700; font-size: 1.25rem; letter-spacing: 0.5px;">
            <i class="fa fa-search me-2" style="color: #6777ef;"></i> Meta & SEO Information
        </h5>
    </div>
    <div class="card-body p-4">
