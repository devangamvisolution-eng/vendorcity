...
<style>
    ...
    .service-form-wrapper {
        ...
        margin: auto;
        padding: 16px 20px;
        background: #f6f7f9; /* Outer background */
    }
    .compact-card {
        background: #fff;
                ...
                <h5><i class="fa fa-info-circle me-2" style="color: #6777ef;"></i> Basic & Other Information</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="servicename" name="servicename" type="text"
                                                    class="form-control" placeholder="Enter Service Name" value="" />
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <p class="form-error-text" id="form_fields_error" style="color: red; margin-top: 10px;"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="form_fields_two" name="form_fields_two[]" multiple="multiple">
                                                    <option value="">Select Form Fields</option>
                                                    @if ($form_field_data != '' && count($form_field_data) > 0)
                                                        @foreach ($form_field_data as $form_field)
                                                            <option value="{{ $form_field->id }}">
                                ...
                                <div class="compact-card">
                                    <div class="compact-header">
                                        ...
                                        <button class="btn btn-sm btn-primary" type="button" id="add_field_button" style="height: 34px; font-size: 13px; font-weight: 500; border-radius: 6px;">+ Add More</button>
                                    </div>
                                    <div>
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"> <label for="categoryname">Image (2025px X 660px)</label>
                                                <input type="file" id="image" name="image_addmore_banner1[]" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="name">Mobile Banner Image (400px x 475px)</label>
                                                <input id="mobile_banner_image_addmore" name="mobile_banner_image_addmore1[]" type="file" class="form-control" value="" />
                                                <p class="form-error-text" id="ombile_banner_image_error" style="color: red; margin-top: 10px;"></p>
                                            </div>
                                        </div>

                                        <div class="col-md-5">
                                            <div class="form-group"> <label for="categoryname">Short Description</label>
                                                <textarea id="description_addmore_banner" name="description_addmore_banner1[]" class="form-control" placeholder="Enter Description"></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="compact-card">
                                    <div class="compact-header">
                                        ...
                                        <button class="btn btn-sm btn-primary" type="button" id="add_field_button01_top_description" style="height: 34px; font-size: 13px; font-weight: 500; border-radius: 6px;">+ Add More</button>
                                    </div>
                                    <div></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group"> <label for="categoryname">Description</label>
                                                <textarea id="description_addmore_top_description" name="description_addmore_top_description[]" class="form-control" placeholder="Enter Description"></textarea>
                                            </div>
                                        </div>
                                    </div>
...
<div class="compact-card">
                                    <div class="compact-header">
                                        ...
                                        <button class="btn btn-sm btn-primary" type="button" id="add_field_button02" style="height: 34px; font-size: 13px; font-weight: 500; border-radius: 6px;">+ Add More</button>
                                    </div>
                                    <div>
                                    @php
                                        $k = 0;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"> <label for="categoryname">Meta Title</label>
                                                <input type="text" id="meta_title" name="meta_title1[]" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"><label for="categoryname">Meta Description</label>
                                                <textarea id="meta_description" name="meta_description1[]"
                                                    class="form-control"
        ...
        <div class="sticky-action-bar">
            ...
            <button type="button" class="btn btn-primary" id="submit_button" onclick="javascript:service_validation()">Save Service</button>
        </div>
    </form>
</div>
    ...
    ClassicEditor.create(document.querySelector('#description_addmore_top_description'), {
        ...
        $(add_button_top).click(function (e) {
            ...
            if (b_top < max_fields) {
                b_top++;
                var newField = $(
                    '<div class="row border-top pt-3 mt-3"><div class="col-md-9"><div class="form-group"> <label>City</label><select class="form-control" name="city_addmore_top_description[]"><option value="">Select City</option>@foreach ($allcity as $data)<option value="{{ $data->id }}">{{ $data->name }}</option>@endforeach</select></div></div><div class="col-md-9"><div class="form-group"><label>Description</label><textarea id="description_addmoree_top_description_' + b_top + '" name="description_addmore_top_description[]" class="form-control"></textarea></div></div><div class="col-md-3 d-flex align-items-end"><a href="#" class="btn btn-sm btn-danger remove_field01_top_description w-100 mb-2" style="height: 38px;">Remove</a></div></div>'
                );
                $(wrapper_top).append(newField);
                var newDesc = newField.find('#description_addmoree_top_description_' + b_top);
                ClassicEditor.create(newDesc[0], { heading: { options: [{ model: 'paragraph', title: 'Paragraph', class: 'ck-heading_paragraph' }, { model: 'heading1', view: 'h1', title: 'Heading 1', class: 'ck-heading_heading1' }, { model: 'heading2', view: 'h2', title: 'Heading 2', class: 'ck-heading_heading2' }, { model: 'heading3', view: 'h3', title: 'Heading 3', class: 'ck-heading_heading3' }, { model: 'heading4', view: 'h4', title: 'Heading 4', class: 'ck-heading_heading4' }, { model: 'heading5', view: 'h5', title: 'Heading 5', class: 'ck-heading_heading5' }, { model: 'heading6', view: 'h6', title: 'Heading 6', class: 'ck-heading_heading6' }] } }).catch(error => { console.error(error); });
            }
        });
        ...
        $('form').submit(function () {
            $('.input_fields_wrap textarea, .input_fields_wrap01_top_description textarea, .input_fields_wrap01 textarea').each(function () {
