...
<div class="content container-fluid">
    <div class="detail-header-bg">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3 class="text-white mb-1"><i class="bi bi-file-earmark-text me-2"></i>Survey Order #{{ $order->format_order_id }}</h3>
                <p class="text-white-50 mb-0">Placed on {{ date('d M Y, h:i A', strtotime($order->created_at ?? ($orderItem->cdate ?? date('Y-m-d H:i:s')))) }}</p>
            </div>
            <a href="{{ route('survey-orders.index') }}" class="btn btn-light rounded-pill px-4"><i class="bi bi-arrow-left me-2"></i>Back to List</a>
        </div>
    </div>
            ...
            <div class="card glass-card border-0 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <p class="label-caps mb-1">Survey Date</p>
                    ...
                    @if(isset($orderItem) && $orderItem->subservice_id == 102)
                    <hr class="my-4">
