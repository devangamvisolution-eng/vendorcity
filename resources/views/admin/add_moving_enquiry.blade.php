            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('frontuser.index') }}">Add Moving & Storage Enquiry</a></li>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="customer_id" name="customer_id" class="form-control form-select">
                                            ...
                                            @foreach ($customer_data as $item)
                                                <option value="{{ $item->id }}" data-email="{{ $item->email }}" data-name="{{ $item->name }}" data-phone = "{{ $item->mobile }}">{{ $item->id }}-{{ $item->name }}-{{ $item->email }}</option>
                                            @endforeach
                                        </select>
                                        <p class="form-error-text" id="customer_id_error" style="color: red; margin-top: 10px;"></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <p class="form-error-text" id="service_id_error" style="color: red; margin-top: 10px;"></p>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Sub Service Name</label>
                                        <select id="sub_service_id" name="sub_service_id" class="form-control form-select" onchange="getForms()">
                                            <option value="">Select Sub Service</option>
                                        </select>

                                        <p class="form-error-text" id="sub_service_id_error" style="color: red; margin-top: 10px;"></p>
                                ...
                                <div class="col-md-3 enquiry_type_div" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <select id="enquiry_type" name="enquiry_type" class="form-control form-select" onchange="getForms()">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, value) {
                        $('#sub_service_id').append('<option value="'+ value.id +'">'+ value.subservicename +'</option>');
                    });
                }
            });
        } else {
