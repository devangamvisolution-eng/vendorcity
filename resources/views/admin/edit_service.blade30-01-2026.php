                        ...
                        <form id="service_form" action="{{ route('service.update', $service->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="country" name="country[]"
											...
											@php  
                                            $countryArray = json_decode($service->country, true);
                                            @endphp
								...
								<div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="homeicon_alt_tag" name="homeicon_alt_tag" type="text" class="form-control"
                                            value="{{$service->homeicon_alt_tag}}" placeholder="Home Icon Alt tag"/>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="homebanner_alt_tag" name="homebanner_alt_tag" type="text" class="form-control"
                                            value="{{$service->homebanner_alt_tag}}" placeholder="Home Banner Alt tag"/>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="homebanner_mobile_alt_tag" name="homebanner_mobile_alt_tag" type="text" class="form-control"
                                            value="{{$service->homebanner_mobile_alt_tag}}" placeholder="Home Mobile Banner Alt tag"/>
                                ...
                                <div class="row">
                                 ...
                                 @if ($service_top_description_attr != '')
                                    ...
                                    @for ($i = 0; $i < count($service_top_description_attr); $i++)
                                        ...
                                        <select class="form-control" id="city_addmore_top_descriptionu" name="city_addmore_top_descriptionu[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}"@if($data->id == $service_top_description_attr[$i]->city) selected @endif>{{ $data->name }}
                                                </option>
                                            @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group"> <label for="categoryname">Description</label>
                                                    ...
                                                    <textarea id="description_addmore_top_descriptionu_{{ $service_top_description_attr[$i]->id }}" name="description_addmore_top_descriptionu[]"
                                                        class="form-control" placeholder="Enter Description">{{ $service_top_description_attr[$i]->description }}</textarea>
                                                </div>
                                            </div>
                                 ...
                                 <input type="hidden" name="title_addmore_banner1[]" value="">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="updateid1xxx0[]"
                                             ...
                                             <div class="col-md-4">
                                        <div class="form-group"> <label for="categoryname">City</label>
                                        <select class="form-control" id="city_addmore_banner" name="city_addmore_banneru[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}" {{ $data->id == $banner_attribute_data[$i]->city ? 'selected' : '' }}>{{ $data->name }}
                                                </option>
                                            @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"> <label for="categoryname">Title</label>
                                                <input type="text" id="title_addmore_banner" name="title_addmore_banneru[]"
                                                    class="form-control" placeholder="Enter  Title" value="{{ $banner_attribute_data[$i]->title }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="mobile_banner_image_addmore" name="mobile_banner_image_addmoreu[]" type="file"
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group"> <label for="categoryname">Description</label>
                                                ...
                                                <textarea id="description_addmoreu_{{ $banner_attribute_data[$i]->id }}" name="description_addmore_banneru[]" class="form-control"
                                                    placeholder="Enter Description">{{ $banner_attribute_data[$i]->short_description }}</textarea>
                                            </div>
                                        </div>
                                ...
                                @else
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group"> <label for="categoryname">Title</label>
                                            <input type="text" id="title_addmore_banner" name="title_addmore_banner1[]" class="form-control" placeholder="Enter  Title" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for="name">Mobile Banner Image (400px x 475px)</label>
                                        <input id="mobile_banner_image_addmore" name="mobile_banner_image_addmore1[]" type="file"
                                            class="form-control" value="" />
                                ...
                                @if (!empty($package_attribute_data))
                                    ...
                                    <input type="file" name="image_addmore1[]" value=""
                                        style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="updateid1xxx1[]"
                                             ...
                                             <div class="col-md-4">
                                        <div class="form-group"> <label for="categoryname">City</label>
                                        <select class="form-control" id="city_addmore_second" name="city_addmore_secondu[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}" {{ $data->id == $package_attribute_data[$i]->city ? 'selected' : '' }}>{{ $data->name }}
                                                </option>
                                            @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"> <label for="categoryname">Title</label>
                                                <input type="text" id="title_addmoreu" name="title_addmoreu[]"
                                                    class="form-control" placeholder="Enter  Title" value="{{ $package_attribute_data[$i]->title_addmore }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group"> <label for="categoryname">image</label>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group"> <label for="categoryname">Description</label>
                                                {{-- <input type="text" id="description_addmore1"
                                                    name="description_addmore1[]" class="form-control"
                                                    placeholder="Enter Description"> --}}
                                                <textarea id="description_addmoreu_{{ $package_attribute_data[$i]->id }}" name="description_addmoreu[]" class="form-control"
                                                    placeholder="Enter Description">{{ $package_attribute_data[$i]->description_addmore }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group"> <label for="categoryname">Image Alt tag</label>
                                                <input type="text" id="image_alt_tag_addmoreu" name="image_alt_tag_addmoreu[]"
                                                    class="form-control" placeholder="Enter  Image Alt tag" value="{{ $package_attribute_data[$i]->image_alt_tag }}">
                                            </div>
                                        </div>
                                        <a href="#"
                                ...
                                @else
                                    ...
                                    <div class="row">
                                          <div class="col-md-4">
                                        <div class="form-group"> <label for="categoryname">City</label>
                                        <select class="form-control" id="city_addmore_second" name="city_addmore_second1[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}">{{ $data->name }}
                                                </option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"> <label for="categoryname">Image Alt tag</label>
                                                <input type="text" id="image_alt_tag_addmore1" name="image_alt_tag_addmore1[]"
                                ...
                                @if (!empty($service_contains_data))
                                    ...
                                    <div class="row">
                                        ...
                                        <select class="form-control" id="city_addmore_thirdu" name="city_addmore_thirdu[]">
                                            <option value="">Select City</option>
                                            @foreach ($allcity as $data)
                                                <option value="{{ $data->id }}"@if($data->id == $service_contains_data[$i]->city) selected @endif>{{ $data->name }}
                                                </option>
                                            @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group"> <label for="categoryname">Meta Title</label>
                                            <input type="text" id="meta_title" name="meta_titleu[]" class="form-control"
                                                placeholder="" value="{{ $service_contains_data[$i]->meta_title }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group"> <label for="categoryname">Meta Keyword</label>
                                            <input type="text" id="meta_keyword" name="meta_keywordu[]" class="form-control"
                                                placeholder="" value="{{ $service_contains_data[$i]->meta_keyword }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
...
@section('footer_js')
    ...
    <script>
		...
		ClassicEditor.create(document.querySelector('#description_addmore_top_descriptionu_{{ $service_top_description_attr[$i]->id }}'), {
            heading: {
                options: [
                { model: 'paragraph', title: 'Paragraph', class: 'ck-heading_paragraph' },
                { model: 'heading1', view: 'h1', title: 'Heading 1', class: 'ck-heading_heading1' },
