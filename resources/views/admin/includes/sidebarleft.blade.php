        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
                ...
                @if (in_array('54', $permission1))
                    <li class="{{ request()->segment(2) == 'help' ? 'active' : '' }}"><a
                ...
                @if (in_array('22', $permission1) ||
                    ...
                    <li class="submenu">
                        <a href="#"
                            class="{{ request()->segment(2) == 'vendor-commission-report' || request()->segment(1) == 'vendors-filter' || request()->segment(1) == 'vendorsubscriptionreport' || request()->segment(1) == 'vendors-filter' || request()->segment(2) == 'salesreport' || request()->segment(2) == 'sales-report' || request()->segment(2) == 'cleaner-report' || request()->segment(2) == 'day-report' || request()->segment(2) == 'day-report-filter' || request()->segment(2) == 'salesperson-report' ? 'active' : '' }}"><i
                                data-feather="file"></i><span>Reports</span><span class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="#"
                            class="{{ request()->segment(2) == 'userpermission' || request()->segment(2) == 'adminuser' || request()->segment(2) == 'driver' || request()->segment(2) == 'cleaners' ? 'active' : '' }}"><i
                                data-feather="user"></i> <span> User Management</span> <span
