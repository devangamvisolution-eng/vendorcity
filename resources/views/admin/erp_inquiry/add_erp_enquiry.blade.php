            ...
            <div class="col-lg-12">
                <div class="custom-card">
                    <div class="card-header">
                        <h4><i class="fas fa-plus-circle me-2"></i> Create New Enquiry</h4>
                    </div>
                    <div class="card-body">

                        <form id="erp_enquiry_form" action="{{ route('erp_enquiry.store') }}" method="POST"
                            ...
                            <div class="row">
                                    ...
                                    <select name="customer_type" id="customer_type" class="form-select select">
                                        ...
                                        @foreach ($customer_type as $customer_type_data)
                                            <option value="{{ $customer_type_data->id }}"
                                                {{ old('customer_type') == $customer_type_data->id ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input id="enquiry_date" name="enquiry_date" type="text" class="form-control"
                                        value="{{ old('enquiry_date') }}" placeholder="YYYY-MM-DD" autocomplete="off" />
                                    @error('enquiry_date')
                                        <div class="form-error-text text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="checkbox-group mt-4">
                                <input type="checkbox" id="client_box" name="client_box" value="1"
                                    onchange="clientvisibility()" {{ old('client_box') == 1 ? 'checked' : '' }}>
                                <label for="client_box">Enable Client Details</label>
                            </div>

                            <div id="client_fields" class="{{ old('client_box') == 1 ? '' : 'hidden' }}">
                                <div class="section-title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <label class="form-label" for="client_email">Client Email<span
                                                class="required-star">*</span></label>
                                        <input id="client_email" name="client_email" type="email" class="form-control"
                                            value="{{ old('client_email') }}" placeholder="Enter Client Email" />
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input id="client_mobile" name="client_mobile" type="text"
                                            class="form-control" value="{{ old('client_mobile') }}"
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input id="contact_person_mobile" name="contact_person_mobile" type="text"
                                            class="form-control" value="{{ old('contact_person_mobile') }}"
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <label class="form-label" for="address">Address<span
                                                class="required-star">*</span></label>
                                        <textarea class="form-control" id="address" name="address" rows="1" placeholder="Enter Address">{{ old('address') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input id="desc_of_goods" name="desc_of_goods" type="text"
                                            class="form-control" value="{{ old('desc_of_goods') }}"
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input id="service_required" name="service_required" type="text"
                                            class="form-control" value="{{ old('service_required') }}"
                                            placeholder="Enter Service Required" />
                                        @error('service_required')
                                            <div class="form-error-text text-danger">{{ $message }}
                                            </div>
                                        @enderror
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input id="mode_of_transport" name="mode_of_transport" type="text"
                                            class="form-control" value="{{ old('mode_of_transport') }}"
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input id="estimated_volume" name="estimated_volume" type="text"
                                            class="form-control" value="{{ old('estimated_volume') }}"
                                    ...
                                    <div class="col-lg-6 mt-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="origin_add" type="text" class="form-control"
                                                value="{{ old('origin_add') }}" placeholder="Origin Address" />
                                            @error('origin_add')
                                                <div class="form-error-text text-danger">{{ $message }}
                                                </div>
                                            @enderror
                                            ...
                                            <select name="origin_country" class="form-select">
                                                ...
                                                @foreach ($country_data as $country)
                                                    <option value="{{ $country->id }}"
                                                        {{ old('origin_country') == $country->id ? 'selected' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="origin_state" type="text" class="form-control"
                                                    value="{{ old('origin_state') }}" placeholder="State" />
                                                @error('origin_state')
                                                    <div class="form-error-text text-danger">
                                                        {{ $message }}
                                                    </div>
                                                @enderror
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="origin_city" type="text" class="form-control"
                                                    value="{{ old('origin_city') }}" placeholder="City" />
                                                @error('origin_city')
                                                    <div class="form-error-text text-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="origin_location" type="text" class="form-control"
                                                    value="{{ old('origin_location') }}" placeholder="Location" />
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="origin_zip_post" type="text" class="form-control"
                                                    value="{{ old('origin_zip_post') }}" placeholder="ZIP" />
                                    ...
                                    <div class="col-lg-6 mt-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="desti_add" type="text" class="form-control"
                                                value="{{ old('desti_add') }}" placeholder="Destination Address" />
                                            @error('desti_add')
                                                <div class="form-error-text text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select name="desti_country" class="form-select">
                                                ...
                                                @foreach ($country_data as $country)
                                                    <option value="{{ $country->id }}"
                                                        {{ old('desti_country') == $country->id ? 'selected' : '' }}>
                                                        {{ $country->country }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="desti_state" type="text" class="form-control"
                                                    value="{{ old('desti_state') }}" placeholder="State" />
                                                @error('desti_state')
                                                    <div class="form-error-text text-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="desti_city" type="text" class="form-control"
                                                    value="{{ old('desti_city') }}" placeholder="City" />
                                                @error('desti_city')
                                                    <div class="form-error-text text-danger">{{ $message }}
                                                    </div>
                                                @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="desti_location" type="text" class="form-control"
                                                    value="{{ old('desti_location') }}" placeholder="Location" />
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="desti_zip_post" type="text" class="form-control"
                                                    value="{{ old('desti_zip_post') }}" placeholder="ZIP" />
                            ...
                            <div class="checkbox-group mt-4">
                                <input type="checkbox" id="general_info_details" name="general_info_details"
                                    ...
                                    {{ old('general_info_details') == 1 ? 'checked' : '' }}>
                                <label for="general_info_details">Enable General Information</label>
                            </div>

                            <div id="general_info_fields" class="{{ old('general_info_details') == 1 ? '' : 'hidden' }}">
                                <div class="section-title">
                                ...
                                <div class="row">
                                        ...
                                        <select name="sourcelead_id" class="form-select">
                                            ...
                                            @foreach ($sourcelead_data as $sourcelead)
                                                <option value="{{ $sourcelead->id }}"
                                                    {{ old('sourcelead_id') == $sourcelead->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <select name="enquiry_mode" class="form-select">
                                            ...
                                            @foreach ($enquiry_mode_data as $data)
                                                <option value="{{ $data->id }}"
                                                    {{ old('enquiry_mode') == $data->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <select name="status_id" class="form-select">
                                            ...
                                            <option value="0" {{ old('status_id') === '0' ? 'selected' : '' }}>Active
                                            </option>
                            ...
                            <div class="row mt-5">
                                <div class="col-12 text-end">
                                    ...
                                    <button type="button" class="btn-submit" id="submit_button"
                                        ...
                                        <i class="fas fa-check-circle"></i> Save Enquiry
                                    </button>
