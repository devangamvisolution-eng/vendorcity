                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="country_code" name="country_code" type="text" class="form-control"
                                        placeholder="Enter Country Code" value="{{ $country->country_code }}" />
                                    <p class="form-error-text" id="country_code_error" style="color: red; margin-top: 10px;"></p>
                                </div>
                            </div>
    ...
    <script>
        function category_validation() {
         ...
         var country = jQuery("#country").val();
            ...
            if (country_code == '') {
                jQuery('#country_code_error').html("Please Enter Country Code");
                jQuery('#country_code_error').show().delay(0).fadeIn('show');
                jQuery('#country_code_error').show().delay(2000).fadeOut('show');
                $('html, body').animate({
                    scrollTop: $('#country_code').offset().top - 150
                }, 1000);
                return false;
            }
            $('#spinner_button').show();
