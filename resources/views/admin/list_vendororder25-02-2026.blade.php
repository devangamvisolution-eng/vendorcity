            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        @elseif(Route::currentRouteName() == 'handyman-and-service-listing')
                            <li class="breadcrumb-item active">Package Order - Handyman & Service</li>
                        @else
                                        ...
                                        @if (isset($vendororders_list) and count($vendororders_list))
                                            @foreach ($vendororders_list as $key => $vendororders)
                                                <tr>
                                                    ...
                                                    @if (Route::currentRouteName() == 'cleaning-listing')
                                                        <td>
                                                            @if ($vendororders->items[0]->cleaner_id)
                                                                @php
                                                                    $cleaner_Id = explode(
                                                                        ',',
                                                                        $vendororders->items[0]->cleaner_id,
                                                                    );
                                                                @endphp
                                                        ...
                                                        @if (isset($vendororders->items[0]) && isset($vendororders->items[0]->service_id))
                                                            @if ($vendororders->items[0]->subservice_id == 52)
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('vendor-handyman-and-service-detail', [$vendororders->order_id]) }}"><i
                                                                        class="far fa-eye me-2"></i></a>
                                                            @elseif($vendororders->items[0]->service_id == 34)
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('vendor-painting-detail', [$vendororders->order_id]) }}"><i
                                                                        class="far fa-eye me-2"></i></a>
                                                            @elseif($vendororders->items[0]->service_id == 45)
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('vendor-cleaning-detail', [$vendororders->order_id]) }}"><i
                                                                        class="far fa-eye me-2"></i></a>
                                                            @elseif($vendororders->items[0]->service_id == 48)
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('vendor-salon-spa-detail', [$vendororders->order_id]) }}"><i
                                                                        class="far fa-eye me-2"></i></a>
                                                            @elseif($vendororders->items[0]->service_id == 47)
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('vendor-pest-control-detail', [$vendororders->order_id]) }}"><i
                                                                        class="far fa-eye me-2"></i></a>
                                                            @elseif($vendororders->items[0]->service_id == 50 && $vendororders->items[0]->subservice_id == 92)
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('vendor-car-inspection-detail', [$vendororders->order_id]) }}"><i
                                                                        class="far fa-eye me-2"></i></a>
                                                            @elseif($vendororders->items[0]->service_id == 50 && $vendororders->items[0]->subservice_id != 92)
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('vendor-automobile-detail', [$vendororders->order_id]) }}"><i
                                                                        class="far fa-eye me-2"></i></a>
                                                            @else
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('vendor-moving-detail', [$vendororders->order_id]) }}"><i
                                                                        class="far fa-eye me-2"></i></a>
                                                            @endif
                                                        @endif

                                                        <a class="btn btn-primary" href="javascript:void(0)"
                                                            onclick="assign_driver('{{ $vendororders->order_id }}');"><i
