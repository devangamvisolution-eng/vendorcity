           ...
           <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            @if($userdata->vendor == 1)
                                ...
                                <input type="hidden" name="vendorname" id="vendorname" value="{{ $userdata->id }}">
                            @else
               ...
               <div class="col-sm-3 col-md-4">
                <div class="form-group">
                    ...
                    <a class="btn btn-secondary btn-premium filter-btn" href="{{ route('vendor-commission-report') }}" style="margin-top: 22px; background: #6c757d; color: white;">Reset</a>
                    </div>
               </div>
           </div>
        </form>
                            ...
                            <div class="col-md-5 col-lg-4">
                                <div class="card premium-card mb-0 shadow-sm" style="border: 1px solid #eef2f5;">
                                    <div class="card-header bg-light border-bottom">
                                        <h5 class="card-title mb-0 text-center text-uppercase fw-bold" style="letter-spacing: 1px; font-size: 14px; color: #495057;">Summary</h5>
                                    </div>
                                    <div class="card-body p-0">
                                        <table class="table premium-table mb-0" id="summary_table">
                                            ...
                                            @endphp
                                            <tr>
                                                <td class="text-muted fw-bold" style="padding: 12px 20px; font-size: 14px; border-bottom: 1px solid #f1f3f5;">Vat on Sum of charges</td>
                                                <td class="text-end fw-bold text-dark" style="padding: 12px 20px; font-size: 14px; border-bottom: 1px solid #f1f3f5;">{{ number_format($vat_on_sum_charge, 2) }}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted fw-bold" style="padding: 12px 20px; font-size: 14px; border-bottom: 1px solid #f1f3f5;">Total VC Commision</td>
                                                <td class="text-end fw-bold text-dark" style="padding: 12px 20px; font-size: 14px; border-bottom: 1px solid #f1f3f5;">{{ number_format($vc_commission, 2) }}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted fw-bold" style="padding: 12px 20px; font-size: 14px; border-bottom: 1px solid #f1f3f5;">Vendors Total</td>
                                                <td class="text-end fw-bold text-dark" style="padding: 12px 20px; font-size: 14px; border-bottom: 1px solid #f1f3f5;">{{ number_format($vendor_total, 2) }}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted fw-bold" style="padding: 12px 20px; font-size: 14px; border-bottom: 1px solid #f1f3f5;">Vendor Received</td>
                                                <td class="text-end fw-bold text-dark" style="padding: 12px 20px; font-size: 14px; border-bottom: 1px solid #f1f3f5;">{{ number_format($vendor_received, 2) }}</td>
                                            </tr>
                                            <tr style="background-color: #f8f9fa;">
                                                <td class="fw-bold" style="padding: 16px 20px; font-size: 15px; color: #0d6efd; border-bottom: none;">Paid to Vendor</td>
                                                <td class="text-end fw-bold" style="padding: 16px 20px; font-size: 16px; color: #0d6efd; border-bottom: none;">{{ number_format($paid_to_vendor, 2) }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
