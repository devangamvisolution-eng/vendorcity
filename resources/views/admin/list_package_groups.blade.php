    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Package Group</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">Package Group</li>
                    </ul>
                </div>
                @if (in_array('83', $edit_perm))
                    <div class="col-auto">
                        ...
                        <a class="btn btn-primary me-1" href="{{ route('packagegroup.create') }}">
                            <i class="fas fa-plus"></i> Add Package Group
                        </a>
                        <a class="btn btn-danger me-1" href="javascript:void('0');"
                            onclick="delete_packagegroup();return false;">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_packagegroup') }}" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable" id="example">
                                    ...
                                    <tbody>
                                        @foreach ($packagegroup_data as $data)
                                            <tr>
                                                <td>
                                                ...
                                                <td>{{ $data->packagecategory_name }}</td>
                                                ...
                                                @if (in_array('83', $edit_perm))
                                                    ...
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('packagegroup.edit', $data->id) }}"><i
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="delete_packagegroup" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-text text-center">
                        ...
                        <h3>Are you sure you want to change the Show Category </h3>
    ...
    <script>
        function delete_packagegroup() {
            // alert('test');
            var checked = $("#form input:checked").length > 0;
            if (!checked) {
                $('#select_one_record').modal('show');
            } else {
                $('#delete_packagegroup').modal('show');
            }
        }
    ...
    <script>
        ...
        function fun_review_status() {
            ...
            $.ajax({
                ...
                url: "{{ route('packagegroup.change_status') }}",
                ...
                success: function(returndata) {
                    ...
                    if (returndata == 1)
                        ...
                        $('#success_message').text('Show category has been Updated successfully');
        ...
        function updateorder() {
            ...
            $.ajax({
                ...
                url: "{{ route('packagegroup.set_order') }}",
