                            ...
                            <div class="row">
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <select name="group_id" id="group_id" class="form-control">
                                        ...
                                        <option value="{{ $all_group_data['id'] }}" @if
                                            ($all_group_data['id']==$service->group_id) {{ 'selected' }} @endif>
                                ...
                                <div class="compact-card">
                                    ...
                                    <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="country" name="country[]"
                                                        ...
                                                        @php $countryArray = explode(',', $service->country); @endphp@foreach ($country_data as $country)
                                                            <option value="{{ $country->id }}" {{ in_array($country->id, $countryArray) ? 'selected' : '' }}>
                                                                {{ $country->country }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                        ...
                                                        <select class="form-control" id="city" name="city[]"
                                                            ...
                                                            @if ($allcity != '' && count($allcity) > 0)
                                                                ...
                                                                @foreach ($allcity as $city)
                                                                    <option value="{{ $city->id }}" {{ in_array($city->id, $cityname) ? 'selected' : '' }}>
                                                                        {{ $city->name }}
                                                                    </option>
                                                                @endforeach
                                                            @endif
                                                    ...
                                                    <select class="form-control" id="form_fields" name="form_fields[]"
                                                        ...
                                                        @if ($form_field_data != '' && count($form_field_data) > 0)
                                                            ...
                                                            @foreach ($form_field_data as $form_field)
                                                                <option value="{{ $form_field->id }}" {{ in_array($form_field->id, $mucraft) ? 'selected' : '' }}>
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group"> <label for="categoryname">City</label>
                                                                <select class="form-control" id="city_addmore_banner"
                                                                    ...
                                                                    @foreach ($allcity as $data)
                                                                        <option value="{{ $data->id }}" {{ $data->id == $banner_attribute_data[$i]->city ? 'selected' : '' }}>
                                                                            {{ $data->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group"> <label
                                                                ...
                                                                <textarea
                                                                    id="description_addmoreu_{{ $banner_attribute_data[$i]->id }}"
                                                                    name="description_addmore_banneru[]" class="form-control"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group"> <label for="categoryname">Short
                                                                Description</label>
                                                            <textarea id="description_addmore_banner"
                                                                name="description_addmore_banner1[]" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="form-group"> <label for="categoryname">City</label>
                                                                <select class="form-control" id="city_addmore_top_descriptionu"
                                                                    ...
                                                                    <option value="">Select City</option>
                                                                    @foreach ($allcity as $data)
                                                                        <option value="{{ $data->id }}" @if ($data->id == $service_top_description_attr[$i]->city)
                                                                        selected @endif>
                                                                            {{ $data->name }}
                                                                        </option>
                                                                    @endforeach
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="form-group"> <label
                                                                ...
                                                                <textarea
                                                                    id="description_addmore_top_descriptionu_{{ $service_top_description_attr[$i]->id }}"
                                                                    name="description_addmore_top_descriptionu[]"
                                                                    class="form-control"
                                                                    placeholder="Enter Description">{{ $service_top_description_attr[$i]->description }}</textarea>
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group"> <label
                                                        ...
                                                        <textarea id="description_addmore_top_description"
                                                            name="description_addmore_top_description[]"
                                                            class="form-control"
                                                            placeholder="Enter Description"></textarea>
                                        ...
                                        <div class="compact-card">
                                            <div class="compact-header">
                                                <h5><i class="fa fa-search me-2" style="color: #6777ef;"></i> Meta & SEO
                                                    Information</h5>
                                                <button class="btn btn-sm btn-primary" type="button"
                                                    ...
                                                    @for ($i = 0; $i < count($service_contains_data); $i++)
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group"> <label for="categoryname">City</label>
                                                                    <select class="form-control" id="city_addmore_thirdu"
                                                                        ...
                                                                        <option value="">Select City</option>
                                                                        @foreach ($allcity as $data)
                                                                            <option value="{{ $data->id }}" @if ($data->id == $service_contains_data[$i]->city)
                                                                            selected @endif>
                                                                                {{ $data->name }}
                                                                            </option>
                                                                        @endforeach
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group"><label for="categoryname">Meta
                                                                        Description</label>
                                                                    <textarea id="meta_description" name="meta_descriptionu[]"
                                                                        class="form-control"
                                        ...
                                        <div>
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="scope_of_job" name="scope_of_job" class="form-control"
                                                        placeholder="Enter Scope Of Job">{{ $service->scope_of_job }}</textarea>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="price_includes" name="price_includes"
                                                            class="form-control"
                                                            placeholder="Enter Price Includes">{{ $service->price_includes }}</textarea>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="price_excludes" name="price_excludes"
                                                            class="form-control"
                                                            placeholder="Enter Price Excludes">{{ $service->price_excludes }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="disclaimer" name="disclaimer" class="form-control"
                                                        placeholder="Enter Disclaimer">{{ $service->disclaimer }}</textarea>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="insurance" name="insurance" class="form-control"
                                                            placeholder="Enter Insurance">{{ $service->insurance }}</textarea>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="payment_terms" name="payment_terms"
                                                            class="form-control"
                                                            placeholder="Enter Payment Terms">{{ $service->payment_terms }}</textarea>
