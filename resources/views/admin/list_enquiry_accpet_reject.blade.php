    ...
    <div class="content container-fluid">
        ...
        <div class="detail-card">
            <div class="detail-header">
                <h4><i class="fas fa-info-circle me-2"></i>Packages Enquiry Information</h4>
            </div>
                                        ...
                                        <span class="info-value">
                                            ...
                                            @else
                                                ...
                                                @if (in_array(strtolower($extension), $imageExtensions))
                                                    <a href="{{ url('admin/download/' . $packages_enquiry_data->formfield_value) }}"
        ...
        {{-- Action Buttons --}}
        @if (!empty($packages_enquiry_data))
            <div class="d-flex justify-content-end mb-4">
                <a class="btn btn-primary me-2 px-4 shadow-sm"
                    href="{{ route('accpet_form', [$packages_enquiry_data?->package_inquiry_id, $userId]) }}">
                    <i class="fas fa-check me-1"></i> Accept
                </a>
                <a class="btn btn-danger px-4 shadow-sm" href="javascript:void('0');"
                    onclick="Enquiry('{{ $packages_enquiry_data->package_inquiry_id }}','{{ $userId }}');">
                        ...
                        <div class="col-md-12">
                            <form id="reject_form" method="post" action="{{ route('reason_reject_form') }}">
                                ...
                                <div class="form-group">
                                    <label class="fw-bold mb-3">Reason for Rejection</label>
                                    ...
                                    <div class="mb-2"><input type="radio" class="reject_reason" name="reject_reason"
                                            ...
                                            city</span></div>
                                    <div class="mb-2"><input type="radio" class="reject_reason" name="reject_reason"
                                            id="reason2" value="I do not provide this service"><span> I do not provide
                                            this service</span></div>
                                    <div class="mb-2"><input type="radio" class="reject_reason" name="reject_reason"
                                            id="reason3" value="I do not have availailty on this date"><span> I do not
                                            have availailty on this date</span></div>
                                    <div class="mb-2"><input type="radio" class="reject_reason" name="reject_reason"
                                            id="reason4"
                                            value="Request includes goods that require special handling"><span> Request
                                            includes goods that require special handling </span></div>
                                    <div class="mb-2"><input type="radio" class="reject_reason" name="reject_reason"
                                            id="reject_reason" value="Other"><span> Other</span></div>

                                    <textarea name="reject_reason_text" id="reject_reason_textarea" cols="30" rows="5"
                                ...
                                <div class="text-end mt-3">
                                    <button class="btn btn-primary px-4" type="button"
                                        onclick="javascript:reject_validation()">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
