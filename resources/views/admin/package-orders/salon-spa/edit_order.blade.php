            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('salon-spa-order') }}">Package Order - Salon & Spa</a>
                        </li>
                        <li class="breadcrumb-item active">Edit Package Order - Salon & Spa</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('salon_spa_order_update', $order->order_id) }}" method="POST" id="form"
