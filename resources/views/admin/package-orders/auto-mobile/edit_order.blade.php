...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Package Order - Automobile</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('automobile-order') }}">Package Order -
                                Automobile</a>
                        </li>
                        <li class="breadcrumb-item active">Edit Package Order - Automobile</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('automobile_order_update', $order->order_id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="customer_id" name="customer_id" class="form-control form-select">
                                            ...
                                            @foreach ($customer_data as $item)
                                                <option value="{{ $item->id }}" @selected($item->id == $order->user_id)>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="subservice_id" name="subservice_id" class="form-control form-select">
                                            ...
                                            @foreach ($subservice_data as $item)
                                                <option value="{{ $item->id }}" @selected($item->id == $order->items[0]->subservice_id)>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div id="package_change">
                                                    <select id="package" name="package[]" class="form-control form-select"
                                                        multiple="multiple" onchange="showPackageFields()">
                            ...
                            <div class="text-end mt-4">
                                <a href="{{ route('automobile-order') }}" class="btn btn-primary text-light">Cancel</a>
