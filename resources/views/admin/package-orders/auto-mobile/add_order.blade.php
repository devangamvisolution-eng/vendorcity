            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('automobile-order') }}">Package Order - Automobile</a>
                        </li>
                        <li class="breadcrumb-item active">Add Package Order - Automobile</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('automobile-order-store') }}" method="POST" id="form"
