...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Package Order - Car Service At Home</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('car-services-at-home-service-order') }}">Package Order
                                - Car Service At Home</a></li>
                        <li class="breadcrumb-item active">Edit Package Order - Car Service At Home</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('car_services_at_home_order_update', $order->order_id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div id="car_wash_fields" style="display: none; width: 100%;">
                                    <hr>
                                    <h4>Car Details :</h4>
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="plate_code" name="plate_code" class="form-control"
                                                    ...
                                                    value="{{ isset($order->items[0]) ? $order->items[0]->plate_code : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="plate_number" name="plate_number"
                                                    ...
                                                    value="{{ isset($order->items[0]) ? $order->items[0]->plate_number : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="describe_your_car" name="describe_your_car" class="form-control"
                                                    placeholder="Describe your car (model, color, etc.)">{{ isset($order->items[0]) ? $order->items[0]->describe_your_car : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div class="ev_charger_form" style="display: none;">
                                    <hr>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="charger_type" name="charger_type"
                                                    ...
                                                    @foreach ($ev_charger_type as $key => $data)
                                                        <option value="{{ $data->name }}"
                                                            {{ isset($order->items[0]) && $data->name == $order->items[0]->charger_type ? 'selected' : '' }}>
                                                            {{ $data->name }}
                                                        </option>
                                                    @endforeach
                                                ...
                                                <p class="form-error-text" id="charger_type_error"
                                                    style="color: red; margin-top: 10px;"></p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="installation_charge" name="installation_charge"
                                                    class="form-control "
                                                    value="{{ optional($order->items[0] ?? null)->installation_charge ?? '' }}"
                                                    onchange="ev_calculation();">

                                                <p class="form-error-text" id="installation_charge_error"
                                                    style="color: red; margin-top: 10px;"></p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="installation_location_type" name="installation_location_type"
                                                    class="form-control form-select">
                                                    <option value="">Select Installation Location Type</option>
                                                    @foreach ($ev_charger_location_type as $key => $data)
                                                        <option value="{{ $data->name }}"
                                                            {{ isset($order->items[0]) && $data->name == $order->items[0]->installation_location_type ? 'selected' : '' }}>
                                                            {{ $data->name }}
                                                        </option>
                                                    @endforeach
                                                ...
                                                <p class="form-error-text" id="installation_location_type_error"
                                                    style="color: red; margin-top: 10px;"></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="service_date" id="service_date" class="form-control"
                                            ...
                                            value="{{ $order->items[0]->full_booking_date ?? '' }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Date & Time Charge</label>
                                        <input type="text" name="date_time_charge" id="date_time_charge"
                                            class="form-control" placeholder="Enter Date & Time Charge"
                                            value="{{ old('date_time_charge', $order?->timing_charge ?? '') }}">
                                        <p class="form-error-text" id="date_time_charge_error"
                                            style="color: red; margin-top: 10px;"></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cod_charge" id="cod_charge" class="form-control"
                                            ...
                                            value="{{ old('cod_charge', $order?->cod_charge ?? '') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="address_type" name="address_type" class="form-control form-select">
                                            ...
                                            <option value="home" @selected($order->items[0]->address_type == 'home')>Home</option>
                                            <option value="office" @selected($order->items[0]->address_type == 'office')>Office</option>
                                            <option value="other" @selected($order->items[0]->address_type == 'other')>Other</option>
                                        </select>
                                        ...
                                        <select id="city" name="city" class="form-control form-select">
                                            ...
                                            @foreach ($emiratesList as $emirate)
                                                <option value="{{ $emirate['name'] }}" data-id="{{ $emirate['id'] }}"
                                                    @selected(old('city', $order->items[0]->city ?? '') == $emirate['name'])>
                                                    {{ $emirate['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="area" id="area" class="form-control"
                                            placeholder="Enter Your Area" value="{{ $order->items[0]->area ?? '' }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="building_name" id="building_name"
                                            ...
                                            value="{{ old('building_name', $order->items[0]->building_street_no ?? '') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apartment_villa_num" id="apartment_villa_num"
                                            ...
                                            value="{{ old('apartment_villa_num', $order->items[0]->apartment_villa_no ?? '') }}">
                            ...
                            <div class="text-end mt-4">
                                <a href="{{ route('car-services-at-home-service-order') }}"
...
@section('footer_js')
    ...
    <script>
        function validation() {
            ...
            */
            ...
            var date_time_charge = jQuery("#date_time_charge").val();
            if (date_time_charge == '') {
                jQuery('#date_time_charge_error').html("Please Enter Date Charge");
                jQuery('#date_time_charge_error').show().delay(0).fadeIn('show');
                jQuery('#date_time_charge_error').show().delay(2000).fadeOut('show');
                $('html, body').animate({
                    scrollTop: $('#date_time_charge').offset().top - 150
                }, 1000);
                return false;
            }
        ...
        function ev_calculation() {

            let installation_charge = parseFloat($('#installation_charge').val()) || 0;
            let date_charge = parseFloat($('#date_time_charge').val()) || 0;
            ...
            let sub_total = installation_charge + cod_charge + service_fee + timing_charge + date_charge;
            let vat_charge = 0;
            ...
            //alert(installation_charge);

            $('#service_charge').val(installation_charge.toFixed(2));
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function handleSubserviceChange(subservice_id, isPageLoad = false) {
                if (!subservice_id) return;

                var existingCategories = @json($orderItemPackages->pluck('packagecategory_id') ?? []);
                var subserviceText = $('#subservice_id option[value="' + subservice_id + '"]').text().trim()
                    .toLowerCase();
                ...
                // Toggle Car Wash specific fields
                if (subserviceText.includes('car wash') || subserviceText.includes('carwash')) {
                    $('#car_wash_fields').show();
                } else {
                    $('#car_wash_fields').hide();
                    if (!isPageLoad) {
                        $('#car_wash_fields').find('input, select, textarea').val('');
                    }
                }
                ...
                if (subservice_id == 94) {
                    ...
                    $('.add_to_cart').show();
                    if (!isPageLoad) {
                        $('.ev_charger_form').find('input, select, textarea').val('');
                    }
                }
            ...
            // 2. Event Listener for manual changes
            $('#subservice_id').change(function() {
                handleSubserviceChange($(this).val(), false);
            });

            // 3. Execution on Page Load
            var initialSubservice = $('#subservice_id').val();
            if (initialSubservice) {
                handleSubserviceChange(initialSubservice, true);
            }
        });
        ...
        $(document).ready(function() {
            ...
            function fetchTimeSlots() {
                ...
                // Only run AJAX if we actually have a date
                if (date) {
            ...
            // 3. CALL ON PAGE LOAD (For the Edit Page)
            if ($('#service_date').val()) {
                fetchTimeSlots();
            }
        });
    ...
    <script>
        function package_calculation() {
            ...
            let cod_charge = parseFloat($('#cod_charge').val()) || 0;
            // let timing_charge = parseFloat($('#timing_charge').val()) || 0;
            let date_time_charge = parseFloat($('#date_time_charge').val()) || 0;
            let service_fee = parseFloat($('#service_fee').val()) || 0;
            let include_vat = $('#include_vat').val();

            let sub_total = service_charge + cod_charge + service_fee + date_time_charge;
        ...
        function showPackageFields(isEdit = false) {
            ...
            console.log("packageFields : ", packageFields);
