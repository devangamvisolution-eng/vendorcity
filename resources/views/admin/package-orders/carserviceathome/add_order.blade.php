            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Package Order - Car Service At Home</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('car-services-at-home-service-order-store') }}" method="POST" id="form"
...
@section('footer_js')
    ...
    <script>
        ...
        $('#subservice_id').change(function() {
            ...
            var subserviceText = $('#subservice_id option:selected').text().trim().toLowerCase();
