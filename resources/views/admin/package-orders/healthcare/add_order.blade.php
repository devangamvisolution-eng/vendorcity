            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('healthcare_at_home_package_order') }}">Package Order -
                                Healthcare
                                Service</a></li>
                        <li class="breadcrumb-item active">Add Package Order - Healthcare Service</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('healthcare_at_home_service_order_store') }}" method="POST" id="form"
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="installation_charge" name="installation_charge"
                                                    class="form-control " value="" onchange="ev_calculation();">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="timing_charge" id="timing_charge"
                                            class="form-control" placeholder="Enter Timing Charge" value="0">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="doc_type" name="doc_type" onchange="doc_typechange(this.value)"
                                            class="form-control form-select">
                                            <option value="">Select Document Type</option>
                                            <option value="EmiratesID" selected>Emirates ID</option>
                                            <option value="PassportNumber">Passport Number</option>
                                        </select>
                                        <p class="form-error-text" id="doc_type_error"
                                ...
                                <div class="col-md-4" id="PassportNumberDiv" style="display: none">
                                    <div class="form-group">
                            ...
                            <div class="text-end mt-4">
                                <a href="{{ route('healthcare_at_home_package_order') }}"
...
@section('footer_js')
    ...
    <script>
        function validation() {
            ...
            if (doc_type == '') {
                jQuery('#doc_type_error').html("Please Select Document Type");
                jQuery('#doc_type_error').show().delay(0).fadeIn('show');
                jQuery('#doc_type_error').show().delay(2000).fadeOut('show');
                $('html, body').animate({
                    scrollTop: $('#doc_type').offset().top - 150
                }, 1000);
                return false;
            }

            if (doc_type == 'EmiratesID') {

                var emirates_id_number = jQuery('#emirates_id_number').val();
                if (emirates_id_number == '') {
                    jQuery('#emirates_id_number_error').html("Please Enter Emirates ID Number");
                    jQuery('#emirates_id_number_error').show().delay(0).fadeIn('show');
                    jQuery('#emirates_id_number_error').show().delay(2000).fadeOut('show');
                    $('html, body').animate({
                        scrollTop: $('#emirates_id_number').offset().top - 150
                    }, 1000);
                    return false;
                }
            }

            if (doc_type == 'PassportNumber') {
                var passport_number = jQuery('#passport_number').val();
                if (passport_number == '') {
                    jQuery('#passport_number_error').html("Please Enter Passport Number");
                    jQuery('#passport_number_error').show().delay(0).fadeIn('show');
                    jQuery('#passport_number_error').show().delay(2000).fadeOut('show');
                    $('html, body').animate({
                        scrollTop: $('#passport_number').offset().top - 150
                    }, 1000);
                    return false;
                }
            }
