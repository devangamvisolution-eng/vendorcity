...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Package Order - Healthcare Service</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('healthcare_at_home_service_order') }}">Package Order -
                                Healthcare
                                Service</a></li>
                        <li class="breadcrumb-item active">Edit Package Order - Healthcare Service</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('handyman_order_update', $order->order_id) }}" method="POST" id="form"
