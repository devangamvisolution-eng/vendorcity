                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="plate_code" name="plate_code" class="form-control" placeholder="Enter Plate Code">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Plate Number</label>
                                                <input type="text" id="plate_number" name="plate_number" class="form-control" placeholder="Enter Plate Number">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Car Description</label>
                                                <textarea id="describe_your_car" name="describe_your_car" class="form-control" placeholder="Describe your car (model, color, etc.)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
