                    ...
                    <form action="{{ route('cleaning-order-update', $order->order_id) }}" method="POST" id="form"
                        ...
                        <div class="row">
                            ...
                            <div class="home_cleaning_form"
                                style="{{ isset($order->items[0]) && $order->items[0]->subservice_id == 28 ? '' : 'display: none;' }}">
...
<script>
    ...
    function get_package() {
        ...
        selectedPackages = @json($order - > items[0] - > package_id ?? []) || $('#package').val() || [];
