            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('car-inspection-order') }}">Package Order - Car
                                Inspection</a></li>
                        <li class="breadcrumb-item active">Add Package Order - Car Inspection</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('car_inspection_order_store') }}" method="POST" id="category_form"
                            enctype="multipart/form-data">
                            @csrf
                            <!-- <input type="hidden" name="payment_hidden" id="payment_hidden" value="1"> -->
                            <input type="hidden" name="package_id" id="package_id" value="">
                            <input type="hidden" name="subservice_id" id="subservice_id" value="92">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="pacakge_id" name="pacakge_id" class="form-control form-select"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="inspection_date" type="date" class="form-control "
                                        id="inspection_date" placeholder="Address">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="inspection_time" name="inspection_time" class="form-control form-select">
                                        ...
                                        @foreach ($subservice_timeslot_price as $item)
                                            <option value="{{ $item->time_slot_id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
