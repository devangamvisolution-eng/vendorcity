            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('handyman-service-order') }}">Package Order - Car
                                Inspection</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('car-inspection-order-update', $order->order_id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="customer_id" name="customer_id" class="form-control form-select"
                                            onchange="customerdetails(this.value);">
                                            <option value="">Select Customer Name</option>
                                            @foreach ($customer_data as $item)
                                                <option value="{{ $item->id }}"
                                                    @if ($item->id == $order->user_id) selected @endif>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="select_package_id" name="select_package_id"
                                            class="form-control form-select"
                                            onchange="showpackage
                                        (this.value);">
                                            <option value="">Select Pacakges</option>
                                            @foreach ($package_data as $item)
                                                <option value="{{ $item->id }}"
                                                    @if ($item->id == $order->items[0]->verifybuy_package_id) selected @endif>{{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <p class="form-error-text" id="package_error" style="color: red; margin-top: 10px;">
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <p class="form-error-text" id="mobile-error" style="color: red; margin-top: 10px;">
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="location" name="location" class="form-control form-select">
                                            <option value="">Select</option>
                                            <option value="Abu Dhabi" @if ($order->items[0]->verifybuy_location == 'Abu Dhabi') selected @endif>Abu
                                                Dhabi</option>
                                            <option value="Dubai" @if ($order->items[0]->verifybuy_location == 'Dubai') selected @endif>Dubai
                                            </option>
                                            <option value="Sharjah" @if ($order->items[0]->verifybuy_location == 'Sharjah') selected @endif>
                                                Sharjah</option>
                                            <option value="Ajman" @if ($order->items[0]->verifybuy_location == 'Ajman') selected @endif>Ajman
                                            </option>
                                            <option value="Ras Al Khaimah"
                                                @if ($order->items[0]->verifybuy_location == 'Ras Al Khaimah') selected @endif>Ras Al Khaimah</option>
                                            <option value="Fujairah" @if ($order->items[0]->verifybuy_location == 'Fujairah') selected @endif>
                                                Fujairah</option>
                                            <option value="Umm Al Quwain" @if ($order->items[0]->verifybuy_location == 'Umm Al Quwain') selected @endif>
                                                Umm Al Quwain</option>
                                        </select>
                                        <p class="form-error-text" id="location-error"
                                            style="color: red; margin-top: 10px;"></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="address" type="text" class="form-control " id="address"
                                        placeholder="Address" value="{{ $order->items[0]->verifybuy_address }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="additional_details" class="form-control " row="5" col="30" id="additional_details"
                                        placeholder="Additional Location Details">{{ $order->items[0]->verifybuy_additional_details }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="where_is_car_parked" name="where_is_car_parked"
                                            class="form-control form-select">
                                            <option value="">Select</option>
                                            <option value="Showroom" @if ($order->items[0]->verifybuy_where_is_car_parked == 'Showroom') selected @endif>
                                                Showroom</option>
                                            <option value="Outdoor" @if ($order->items[0]->verifybuy_where_is_car_parked == 'Outdoor') selected @endif>
                                                Outdoor</option>
                                            <option value="Home" @if ($order->items[0]->verifybuy_where_is_car_parked == 'Home') selected @endif>Home
                                            </option>
                                        </select>
                                        <p class="form-error-text" id="where_is_car_parked_error"
                                            style="color: red; margin-top: 10px;"></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="vehicle_make" name="vehicle_make" class="form-control form-select"
                                            onchange="showmodel(this.value)">
                                            <option value="">Select</option>
                                            @foreach ($vehicles as $item)
                                                <option value="{{ $item->id }}"
                                                    @if ($item->id == $order->items[0]->verifybuy_vehicle) selected @endif>{{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <p class="form-error-text" id="vehicle_make-error"
                                            style="color: red; margin-top: 10px;"></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span id="change_model">
                                            <select id="other_vehicle_model" name="other_vehicle_model"
                                                class="form-control form-select" onchange="showPrice(this.value);">
                                                <option value="">Select</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="inspection_date" type="date" class="form-control "
                                        id="inspection_date" placeholder="Address" value="{{ $order->moving_date }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="inspection_time" name="inspection_time" class="form-control form-select">
                                        ...
                                        @foreach ($subservice_timeslot_price as $item)
                                            <option value="{{ $item->time_slot_id }}"
                                                @if ($item->time_slot_id == $order->items[0]->time_slot) selected @endif>{{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="text-end mt-4">
                                <a href="{{ route('car-inspection-order') }}"
