<table>
    <thead>
        <tr>
            <th style="background-color: #2F75B5; color: #FFFFFF; font-weight: bold; width: 10px; text-align: center;">ID</th>
    ...
    <tbody>
        @foreach($enquiries as $enquiry)
            ...
            <tr>
                ...
                <td>{{ $sourceContact }}</td>
                <td style="color: {{ $enquiry->status == 'Booked' ? '#28a745' : ($enquiry->status == 'Pending' ? '#ffc107' : '#000000') }}; font-weight: bold;">
...
<table>
    <thead>
        <tr>
            <th style="background-color: #5B9BD5; color: #FFFFFF; font-weight: bold; text-align: center;" colspan="2">SUBSERVICE WISE COUNT</th>
            <th></th>
            <th style="background-color: #5B9BD5; color: #FFFFFF; font-weight: bold; text-align: center;" colspan="2">SOURCE WISE COUNT</th>
            <th></th>
            <th style="background-color: #5B9BD5; color: #FFFFFF; font-weight: bold; text-align: center;" colspan="2">STATUS WISE COUNT</th>
        </tr>
        <tr>
