        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h3 class="page-title">Rejected Bookings</h3>
                                        ...
                                        @if (isset($vendororders_list) and count($vendororders_list))
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary" href="{{ route('vendor.rejected_booking_details', [$vendororders->order_id]) }}"><i class="far fa-eye me-2"></i></a>
