    ...
    <div class='content container-fluid'>
        <div class='page-header'>
            <div class='row align-items-center'>
                <div class='col'>
                    <h3 class='page-title'>Add CleaningSubscriptionDuration</h3>
                </div>
                <div class='col-auto'><a class='btn btn-primary btn-premium'
                        href="{{ route('cleaning-subscription-durations.index') }}">Back</a></div>
            </div>
        </div>
        <div class='row'>
            <div class='col-md-12'>
                <div class='card premium-card'>
                    <div class='card-body'>
                        <form action="{{ route('cleaning-subscription-durations.store') }}" method='POST'>@csrf <div
                                class='row'>
                                ...
                                <div class='col-md-4 mb-3'>
                                    ...
                                    <input type='number' step='0.01' name='material_price_per_hour' class='form-control'
                                        value='0.00' required>
                                </div>
                                <div class='col-md-4 mb-3'>
                            ...
                            </div><button class='btn btn-primary btn-premium mt-3'>Submit</button></form>
                    </div>
                </div>
            </div>
        </div>
