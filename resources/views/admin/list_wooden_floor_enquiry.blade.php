                                ...
                                @if ($wooden_floor_enquiry != '')
                                    ...
                                    @foreach ($wooden_floor_enquiry as $wooden_data)
                                        <tr>
                                            ...
                                            <td><span class="fw-bold text-primary">#{{ $wooden_data->inquiry_id }}</span>
                                            </td>
                                            <td>
                                                <span class="fw-bold">{{ $wooden_data->name ?? '' }}</span>
                                                <div class="small">{{ $wooden_data->email ?? '' }}</div>
                                                <div class="text-muted small">{{ $wooden_data->mobile ?? '' }}</div>
                                            </td>
                                            <td>
                                                <div class="fw-bold">
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-primary"
                                                    onclick="assign_vendor('{{ $wooden_data->id }}');">
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-info"
                                                    onclick="email_to_vendor('{{ $wooden_data->id }}');">
                                                    <i class="fas fa-envelope me-1"></i> Email
                                                </button>
                                            </td>
                                            <td class="text-end">
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ url('wooden-floor-lead-detail', $wooden_data->id) }}">
                                                    View Info
                                                </a>
                                            </td>
                                        </tr>
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="assign_vendor_model" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="wooden_vendor_form" action="{{ url('wooden-vendor-form') }}" method="POST"
    ...
    <div class="modal custom-modal fade" id="email_vendor_model" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="wooden_email_to_vendor" action="{{ url('wooden-wallet-vendor') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="modal-text text-center">
                        ...
                        <p class="form-error-text" id="wooden_email_vendor_id_error"
