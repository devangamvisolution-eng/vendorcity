...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('customer-wallet.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label>Amount to Add (AED) <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="note" class="form-control" rows="3" placeholder="e.g. Promotional credit, refund..."></textarea>
                                </div>
                            </div>
                        </div>
