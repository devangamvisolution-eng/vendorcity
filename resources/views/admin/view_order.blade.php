                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                @if($visit->visit_status != 'cancelled' && $visit->visit_status != 'completed')
                                                    <button class="btn btn-sm btn-outline-primary assign-cleaner-btn"
                                                        data-date="{{ $visit->visit_date }}" data-order="{{ $order->order_id }}"
                                                        data-cleaner="{{ $visit->cleaner_id }}">
                                                        <i class="fas fa-user-plus me-1"></i> Assign
                                                    </button>
                                                    <button class="btn btn-sm btn-outline-danger cancel-visit-btn"
                                                        data-date="{{ $visit->visit_date }}" data-order="{{ $order->order_id }}">
                                                        <i class="fas fa-times me-1"></i> Skip/Cancel
                                                    </button>
                                                @endif
                                            </td>
                                        </tr>
