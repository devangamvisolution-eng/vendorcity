...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Add Manpower Order</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('manpower-orders.index') }}">Manpower Orders</a></li>
                        <li class="breadcrumb-item active">Add Manpower Order</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="add_form" action="{{ route('manpower-orders.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3" id="survey_div" style="display: none;">
                                    <h4>Manpower Requirment:</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Service Required</label>
                                                <input type="text" name="manpower_service_required" class="form-control" placeholder="Enter Service Required">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Number of Workers</label>
                                                <input type="number" name="manpower_workers_required" class="form-control" placeholder="Enter Number of Workers">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Duration / Per Day</label>
                                                <input type="text" name="manpower_duration" class="form-control" placeholder="Enter Duration">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
