                    ...
                    <div class="card-body p-4">
                        <form id="form" action="" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                <table class="action-table table-hover datatable" id="example">
                                    <thead>
                                        <tr>
                                            ...
                                            @foreach ($package_inquiry_accepted as $package_inquiry_accepted_data)
                                                @php
                                                    $packages_enquiry_data = DB::table('packages_enquiry')
                                                        ...
                                                        ->first();
                                                    $service_quote_includes = DB::table('service_quote_includes')
                                                        ->where('service_id', $packages_enquiry_data->service_id)
                                                        ->get();
                                                @endphp
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="fw-bold text-dark">
                                                            {{ $packages_enquiry_data->name ?? '' }}</div>
                                                        <div class="small text-muted">
                                                            {{ $packages_enquiry_data->email ?? '' }}</div>
                                                        <div class="small text-muted">
                                                            {{ $packages_enquiry_data->mobile ?? '' }}</div>
                                                    </td>
                                                    <td>
                                                        <div class="fw-bold">
                                                    ...
                                                    <td class="text-end">
                                                        <a class="btn btn-sm btn-outline-primary"
                                                            href="{{ url('enquiry_details', $packages_enquiry_data->id) }}"
