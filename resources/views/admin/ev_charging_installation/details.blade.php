            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb small">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('evchargingleads.lists') }}">Enquiry List</a></li>
                        <li class="breadcrumb-item active">View Details</li>
                    </ul>
                </div>
                <div class="col-auto">
                    <a href="{{ route('evchargingleads.lists') }}" class="btn btn-outline-secondary shadow-sm">
