...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Edit Package Group</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('packagegroup.index') }}">Edit Package Group</a>
                        </li>
                        <li class="breadcrumb-item active">Edit Package Group</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('packagegroup.update', $packagegroup->id) }}"
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control" id="service_id" name="service_id"
                                        ...
                                        @foreach ($service_data as $service)
                                            <option value="{{ $service->id }}"
                                                {{ $service->id == $packagegroup->service_id ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control" id="subservice_id" name="subservice_id" onchange="packagecategory_change(this.value);">
                                            ...
                                            @foreach ($subservice_data as $subservice)
                                                <option value="{{ $subservice->id }}"
                                                    {{ $subservice->id == $packagegroup->subservice_id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <span id="packagecategory_chang">
                                        <select class="form-control" id="packagecategory_id" name="packagecategory_id">
                                            ...
                                            @foreach ($packagecategory_data as $packagecategory)
                                                <option value="{{ $packagecategory->id }}"
                                                    {{ $packagecategory->id == $packagegroup->packagecategory_id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control"
                                        placeholder="Enter Package Group Name" value="{{ $packagegroup->name }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="short_description" name="short_description" type="text" class="form-control"
                                        placeholder="Enter Short Description" value="{{ $packagegroup->short_description ?? '' }}" />
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="image" name="image"
                                            value="{{ $packagegroup->image }}">
                                        @if ($packagegroup->image != '')
                                            <img src="{{ asset('public/upload/packagegroup/large/' . $packagegroup->image) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="image_alt_tag" name="image_alt_tag" type="text" class="form-control"
                                        placeholder="Enter Image Alt tag" value="{{ $packagegroup->image_alt_tag }}" />
