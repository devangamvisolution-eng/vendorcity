    ...
    <div class="row justify-content-center">
        <div class="col-xl-8">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-3">
                        ...
                        {{-- @if (isset($order->promo_discount) && $order->promo_discount > 0)
                            <li><strong>Promo Discount :</strong> <span class="right"><span class="currency_dhiram"></span> {{number_format($order->promo_discount,2);}}</span></li>
                        @endif --}}
                        ...
                        @endif
                        @if (isset($order->coupondiscount) && $order->coupondiscount > 0)
                        <li><strong>Discount:</strong> <span class="right">-<span class="currency_dhiram"></span>
                                {{ $order->coupondiscount }}</span></li>
                        @endif
                        @if (isset($order->front_wallet_amount) && $order->front_wallet_amount > 0)
                        <li><strong>Wallet Discount:</strong> <span class="right">-<span
                                    class="currency_dhiram"></span> {{ $order->front_wallet_amount }}</span></li>
                        @endif
            ...
            <div class="text-end mt-4 mb-5">
                ...
                <button class="btn btn-primary mb-1" type="button" disabled id="spinner_button_accept"
                    style="display: none;">
                ...
                <a href="javascript:void(0)" onclick="check_order('{{ $order->order_id }}');"
                    class="btn btn-primary" id="submit_button">Accept</a>

                <button class="btn btn-danger mb-1" type="button" disabled id="spinner_button_reject"
                    style="display: none;">
