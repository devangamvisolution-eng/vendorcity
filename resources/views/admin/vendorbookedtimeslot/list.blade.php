       ...
       <div class="content container-fluid">
           ...
           <div class="page-header">
               <div class="row align-items-center">
                   <div class="col">
                       <h3 class="page-title">Vendor Booked Timeslot</h3>
                       <ul class="breadcrumb">
                           <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a>
                           </li>
                           <li class="breadcrumb-item active">Vendor Booked Timeslot</li>
                       </ul>
                   </div>
                   @if (in_array('66', $edit_perm))
                       <div class="col-auto">
                           <a class="btn btn-primary me-1" href="{{ route('vendorbookedtimeslot.create') }}">
                               <i class="fas fa-plus"></i> Add Vendor Booked Timeslot
                           </a>
           ...
           <div class="row">
               <div class="col-sm-12">
                   ...
                   <div class="card card-table">
                       <div class="card-body">
                           <form id="form" action="{{ route('vendorbookedtimeslot.delete') }}" enctype="multipart/form-data">
                                       ...
                                       <tbody>
                                           @foreach ($alldata as $data)
                                               <tr>
                                                   ...
                                                   <td>{!! Helper::timeslotname($data->timeslot_id) !!}</td>
                                                ...
                                                <td>
                                                     <a class="btn btn-primary"
                                                            href="{{ route('vendorbookedtimeslot.edit', $data->id) }}"><i
