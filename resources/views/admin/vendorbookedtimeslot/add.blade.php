...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Add Vendor Booked Timeslot</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('vendorbookedtimeslot.lists') }}">Add Vendor Booked Timeslot</a>
                        </li>
                        <li class="breadcrumb-item active">Add Vendor Booked Timeslot</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('vendorbookedtimeslot.store') }}" id="category_form_new" method="POST"
...
<div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="vendor_id" name="vendor_id"
                                        ...
                                        @foreach ($carvendor as $carvendorData)
                                            <option value="{{ $carvendorData->id }}">{{ $carvendorData->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="booked_date" name="booked_date">
