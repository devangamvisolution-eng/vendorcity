                                                ...
                                                <div class="wallet-card-ui d-none promo_dicount_replace_div"
                                                    ...
                                                    <div style="display:flex; align-items:center; gap:12px; flex:1;">
                                                        ...
                                                        <div class="wallet-info">
                                                            ...
                                                            <div style="font-size:1.15rem; font-weight:900; color:#16a34a; line-height:1;"
                                                                class="price-wrapper">
            ...
            success: function(response) {
                ...
                if (response === 'invalid') {
                    ...
                    $.get("{{ route('homecleaning.get_coupon') }}", function(couponData) {
                        ...
                        if (couponData) {
                            if (couponData.coupanvalue == '0') {
                                toastMsg = couponData.discount + '% off applied successfully.';
                            } else {
                                toastMsg =
                                    '<span class="price-wrapper"><span class="currency_dhiramnew">AED</span>' +
                                    couponData.discount + '</span> off applied successfully.';
                            }
                        }
                ...
                success: function(response) {
                    if (response === 'success') {
                        ...
                        $.get("{{ route('homecleaning.get_coupon') }}", function(couponData) {
                            ...
                            if (couponData) {
                                if (couponData.coupanvalue == '0') {
                                    toastMsg = couponData.discount +
                                        '% off applied successfully.';
                                } else {
                                    toastMsg =
                                        '<span class="price-wrapper"><span class="currency_dhiramnew">AED</span>' +
                                        couponData.discount +
                                        '</span> off applied successfully.';
                                }
                            }
                            showPromoToast('success', 'Promo Code Applied', toastMsg);
                        });
