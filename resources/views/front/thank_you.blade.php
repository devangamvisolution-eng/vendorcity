...
<section class="wow animate__fadeIn pt40 mt120">
    <div class="container text-center">
        <div class="step-counter"
            style="background-color: #685F5E;color: #fff;border-radius: 50%;position: relative;z-index: 5;display: flex;justify-content: center;align-items: center;width: 80px;height: 80px;margin: 0 auto;border-radius: 50%;">
        ...
        <div class="container stepper-wrapper mobile-view-images" style="width: 60%;">
            <div class="stepper-item completed">
                <div class="step-counter" style="background-color: #0040E6;color: #fff;"><i
                        class="fa-solid fa-pen-to-square"
                        style="font-size: 35px;margin: 0 0 3px 4px;font-weight: 500;"></i>
                </div>
        ...
        <p class="textp">You will receive a detailed invoice on your email address shared.<br>Accepted payment methods
            include cash, credit card, and debit card.</p>
        <p class="textp pt20"><b>Next Steps:</b></p>
        <p class="textp">We will assign a vendor to your service request shortly. They will contact you to <br>confirm
            the details and make any necessary arrangements.</p>
        <p class="textp">Once confirmed, ensure that you are at the specified time and location to <br>receive your
            service.</p>
    </div>
</section>
