                                    ...
                                    @if (!empty($package))
                                        <div class="package-list-container">
                                            @if (count($package) > 3)
                                                ...
                                                <div class="grouped-category-card entrance-anim" style="cursor: pointer;"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#category-modal-{{ $package_cat_data->id }}">
                                                    <div class="grouped-category-header">
                                                        @if (!empty($package_cat_data->slider_image))
                                                            <img src="{{ url('public/upload/packagecategory/' . $package_cat_data->slider_image) }}"
                                                                alt="{{ $package_cat_data->name }}" class="grouped-category-img"
                                                            ...
                                                            <div class="package-list-price-wrap">
                                                                ...
                                                                <div class="package-list-action">
                                                                    <button type="button" class="addbutton"
                                                                        ...
                                                                        data-name="{{ $package_data->name }}" data-price="{{ $price }}"
                                            ...
                                            <div class="addon-img-wrapper">
                                                ...
                                                <div class="addon-action-float">
                                                    <button type="button" class="addons-addbutton addon-float-add"
                                                        ...
                                                        data-price="{{ $priceaddons }}" data-oldprice="{{ $addonsData->price }}"
                            ...
                            @if ($subservice_id == 93)
                                <div class="form-group mb-3 mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-4 mb-2" style="padding-right: 5px; padding-left: 5px;">
                                            <input type="text" class="form-control" name="plate_code" id="plate_code"
        ...
        <div id="step1-static-full-width" style="display: none; clear: both; width: 100%; float: none;">
            <div class="step1-static-content mt-5 " style="clear: both; width: 100%;">
                ...
                @if (isset($google_reviews_data) && count($google_reviews_data) > 0)
                    <div class="what_customer_are_saying_section custommb{{ !$firstSectionRendered ? ' customMt' : '' }}">
                                        ...
                                        <li class="splide__slide">
                                            <div class="testimonial-box h-100"
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <i class="fa-solid fa-star text-dark me-1" style="font-size: 16px;"></i>
                                                        <span class="text-dark fw-bold"
                                                            style="font-size: 16px;">{{ $review->label }}</span>
                                                    </div>
                                                </div>
                                                <div class="text-muted mb-3" style="font-size: 15px; font-weight: 500;">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="faqHeading{{ $faq_index }}">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#faqCollapse{{ $faq_index }}" aria-expanded="false"
                                                aria-controls="faqCollapse{{ $faq_index }}">
                                                {{ $faq_item->question }}
                                            </button>
                                        </h2>
                                        <div id="faqCollapse{{ $faq_index }}" class="accordion-collapse collapse"
                                            aria-labelledby="faqHeading{{ $faq_index }}" data-bs-parent="#faqAccordion">
                                            ...
                                            @if ($subservice_data->$stepTitle || $subservice_data->$stepImage)
                                                <li class="splide__slide">
                                                    <div class="step-img-box">
                                                        ...
                                                        @else
                                                            <img src="{{ asset('public/site/images/no-image.jpg') }}" alt="No Image">
                                                        @endif
                                                    </div>
                                        ...
                                        @else
                                            ...
                                            @endif
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @endphp
                                                        <img src="{{ $image_url }}" alt="{{ $more_service->subservicename }}"
                    ...
                    <div class="subheadingdev">
                        <div
                            ...
                            <div style="display:flex; align-items:center; gap:8px;">
                                <span style="font-size:0.82rem; font-weight:800; color:#16a34a;" class="price-wrapper">
...
@foreach ($package_cat as $package_cat_data)
    ...
    @if (count($package) > 3)
        <!-- Category Modal -->
        <div class="modal fade subservice-read-more-model" id="category-modal-{{ $package_cat_data->id }}" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-drag-handle">
                        ...
                        <div class="package-list-container" style="margin-top: 0;">
                            @foreach ($package as $package_data)
                                ...
                                <div class="package-list-row">
                                    ...
                                    <div class="package-list-body">
                                        <a href="javascript:void(0)" style="text-decoration: none;" data-bs-toggle="modal"
                                            data-bs-target="#package-detail-model_{{ $package_data->id }}">
                                            <h3 class="package-list-title">
                                                {{ $package_data->name }}
                                            </h3>
                                    ...
                                    <div class="package-list-action">
                                        <button type="button" class="addbutton" data-id="{{ $package_data->id }}"
                                            data-name="{{ $package_data->name }}" data-price="{{ $price }}"
                                            data-oldprice="{{ $package_data->price }}"
                                            data-image="{{ !empty($package_data->image) ? asset('public/upload/packages/large/' . $package_data->image) : '' }}"
                                            data-service="{{ $service_id }}" data-subservice_id="{{ $subservice_id }}"
                                            data-type="package">Add +</button>
                                        <div class="quantity-control" data-id="{{ $package_data->id }}" style="display:none;">
                                            <button class="minus-btn" type="button"><i class="fa-solid fa-minus"></i></button>
                                            <span class="quantity">1</span>
                                            <button class="plus-btn" type="button"><i class="fa-solid fa-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
    ...
    @foreach ($package as $package_data)
        ...
        @endphp
        <div class="modal fade subservice-read-more-model" id="package-detail-model_{{ $package_data->id }}" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
...
@if (isset($addons) && count($addons) > 0)
    @foreach ($addons as $addonsData)
        <div class="modal fade subservice-read-more-model" id="addons-detail-model_{{ $addonsData->id }}" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bn-modal-header">
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response === 'success') {
                        ...
                        $.get("{{ route('package.get_coupon') }}", function (couponData) {
                            ...
                            if (couponData && couponData !== 'null' && typeof couponData ===
                                ...
                                if (couponData.minimum_order) {
                                    window.appliedPromoMinOrder = parseFloat(couponData.minimum_order) || 0;
                                }
                        ...
                        showPromoToast('info', 'Notice',
                            'To apply this promo you need a minimum order of ' + response + ' AED'
                        );
        ...
        window.maybeAutoRemovePromo = function (baseTotal) {
            ...
            if (window.appliedPromoMinOrder && rawTotal > 0 && rawTotal < window.appliedPromoMinOrder) {
                ...
                silentRemovePromo(function () {
                    showPromoToast('info', 'Notice', 'Promo code removed because the new total is below the minimum order of ' + window.appliedPromoMinOrder + ' AED');
                    if (typeof updateSidebarCart === 'function') updateSidebarCart();
                });
                return;
            }
