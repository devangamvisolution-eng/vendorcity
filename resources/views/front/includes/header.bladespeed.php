                    ...
                    <div class="row align-items-center justify-content-between">
                                ...
                                <div class="logos">
                                    ...
                                    <a class="header-logo logo1"
                                        href="{{ route('city.home', ['city' => session('search_city_name')]) }}"><img
                                            style="max-width: 150px;" width="150" height="50"
                                    ...
                                    <div id="mega-menu" class="mega-menu-custom dropdown">
                                        ...
                                        <div id="myDropdownnew" class="dropdown-content-new">
                                            ...
                                            <template id="mega-menu-template">
                                                <div class="mega-menu" id="rendered-mega-menu">
                                                            ...
                                                            @foreach ($service_data as $service_datadynamic)
                                                                @php
                                                                    ...
                                                                    $subservice_data = DB::table('subservices')
                                                                        ...
                                                                        ->where('serviceid', $service_datadynamic->id)
                                                                ...
                                                                <div class="mega-item">
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        <h3>{{ $service_datadynamic->servicename }}
                                                                        </h3>
                        ...
                        @php
                            ...
                            if ($display_div_head == 0) {
                                $style_div_head = 'position: absolute; opacity: 0; pointer-events: none;';
                            } else {
                                $style_div_head = 'position: relative; opacity: 1; pointer-events: auto;';
                            }
                        ...
                        <div class="col-auto px-0 head_search_sticky" style="{{ $style_div_head }}">
                        ...
                        <div class="col-auto px-0 resfix resfix-dimensions">
                            ...
                            ">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        class="custom_font_awesome"
                                        style="width: 1em; height: 1em; vertical-align: -0.125em; fill: currentColor; margin-right: 5px;">
                                        <path
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="popup-search-field search_area">
                                ...
                                <label><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        style="width: 1em; height: 1em; vertical-align: -0.125em; fill: currentColor;">
                                        <path
            ...
            <div class="mobile-menu">
                ...
                <div class="header bdrb1">
                    ...
                    <div class="posr">
                        ...
                        <div class="mobile_menu_close_btn"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 320 512"
                                style="width: 1em; height: 1em; vertical-align: -0.125em; fill: currentColor;">
                                <path
