                                 <style>
                                     ...
                                     .service-group:first-child .service-group-title {
                                         margin-top: 0;
                                     }
                                 </style> <!-- Our Footer -->
        ...
        <a href="https://web.whatsapp.com/send?phone=9710568363677" target="_blank"><i class="fab fa-whatsapp"></i></a>
                                     ...
                                     <div class="container">
                                         ...
                                         @php
                                             $cityName_footer = session('search_city_name') ?? 'dubai';
                                             $formattedCity_footer = ucwords(str_replace('-', ' ', $cityName_footer));
                                             $cityData_footer = DB::table('cities')
                                                 ->where('name', $formattedCity_footer)
                                                 ->first();
                                             $cityId_footer = $cityData_footer->id ?? 1;

                                             $services_footer = DB::table('services')
                                                 ->where('is_active', 0)
                                                 ->whereRaw('FIND_IN_SET(?, city)', [$cityId_footer])
                                                 ->orderBy('set_order')
                                                 ->get();

                                             // Pre-fetch ALL subservices for this city in ONE query to eliminate N+1 loop
                                             $all_subservices_footer = DB::table('subservices')
                                                 ->where('is_active', 0)
                                                 ->whereRaw('FIND_IN_SET(?, city)', [$cityId_footer])
                                                 ->orderBy('set_order')
                                                 ->get()
                                                 ->groupBy('serviceid'); // Group by serviceid for fast lookup
                                         @endphp

                                         <!-- Service Areas Section (Sequential Flat List) -->
                                         <div class="service-areas-footer ">
                                             <h4 class="mb-4 text-white fz20 fw600">Explore Service in
                                                 {{ $formattedCity_footer }}</h4>
                                             <div class="d-flex flex-wrap">
                                                 @foreach ($services_footer as $service)
                                                     @php
                                                         // Use pre-fetched data — zero extra DB queries!
                                                         $subservices_footer = $all_subservices_footer->get(
                                                             $service->id,
                                                             collect(),
                                                         );
                                                     @endphp
                                                     @foreach ($subservices_footer as $sub)
                                                         <a href="{{ route('front.package_lists', ['city' => $cityName_footer, 'page_url' => $sub->page_url]) }}"
                                                             class="service-pill">
                                                             {{ $sub->subservicename }}
                                                         </a>
                                                     @endforeach
                                         ...
                                         <div class="row">
                                             <div class="col-lg-12">
                                                 <div
                                                     style="border-bottom: 1px solid rgba(255, 255, 255, 0.1); margin: 10px 0 40px;">
                                                 </div>
                                             </div>
                                         </div>
                                         {{-- <h1 class="mb25" style="color: #fff;font-size: 60px;">VendorsCity</h1> --}}
                                         <img class="mb25 footer-logo" width="200" height="34"
                                         ...
                                         <div class="row">
                                             <div class="col-sm-6 col-lg-3">
                                                 <div class="link-style1 light-style at-home8 mb-4 mb-sm-5">
                                                     ...
                                                     <div class="link-list">
                                                         <a href="{{ route('about_us') }}" style="color: #eee;">About
                                                             Us</a>
                                                         <li><a href="{{ route('contact') }}"
                                                                 style="color: #eee;">Contacting
                                                                 VendorsCity</a></li>
                ...
                <li class="list-inline-item bg-white">
                  <select class="selectpicker show-tick">
                    ...
                    <option>Turkey</option>
                                 ...
                                 @endif
                                 {{-- intlTelInput CSS now in header, no duplicate here --}}
                                 ...
                                 <script>
                                     ...
                                     function adjustMegaMenuPosition() {
                                         ...
                                         if (!megaMenu || !dropdown) return;

                                         // Find visible header to get height based on viewport size
                                         var header;
                                         if (window.innerWidth > 991) {
                                             header = $('header.nav-homepage-style:visible').first();
                                         } else {
                                             header = $('.mobilie_header_nav:visible').first();
                                         }

                                         if (!header.length) {
                                             header = $('header:visible').first();
                                         }

                                         var headerHeight = header.length ? header.outerHeight() : 0;
                                         if (headerHeight === 0) {
                                             headerHeight = window.innerWidth > 991 ? 90 : 70; // Safe fallbacks
                                         }

                                         var tabbyBanner = $('.tabby-banner-wrapper:visible');
                                         var tabbyHeight = tabbyBanner.length ? tabbyBanner.outerHeight() : 0;

                                         var rect = megaMenu.getBoundingClientRect();
                                         var topPosition = (headerHeight) - rect.top - '3px';
                                     ...
                                     function myFunction() {
                                         var dropdown = document.getElementById("myDropdownnew");
                                         dropdown.classList.toggle("show-new");
                                         if (dropdown.classList.contains("show-new")) {
                                             adjustMegaMenuPosition();
                                         }
                                     }

                                     // Keep position adjusted during scroll or resize if menu is open
                                     window.addEventListener('scroll', function() {
                                         var dropdown = document.getElementById("myDropdownnew");
                                         if (dropdown && dropdown.classList.contains("show-new")) {
                                             adjustMegaMenuPosition();
                                         }
                                     }, {
                                         passive: true
                                     ...
                                     <div
                                         ...
                                         <div class="modal-content details-modal-content">
                                             <div class="modal-header details-header">
                                                 <h5 class="modal-title w-100" id="modalStepTitle">Log in or Sign Up
                                                 </h5>
          ...
          <span aria-hidden="true">&times;</span>
                                             ...
                                             <div class="modal-body">
                                                 ...
                                                 <form class="form-horizontal details-form" id="OtpForm"
                                                     method="POST" action="{{ route('user-otp-login') }}">
                                                     @csrf

                                                     <!-- STEP 1: Mobile Input -->
                                                     <div id="step-phone">
                                                         <div class="form-group mb-2">
                                                             <label id="mobilename-label">Please Enter Your WhatsApp
                                                                 mobile
                                                                 number</label>
                                                             ...
                                                             <p id="otp_phone_error" style="display:none;color:red;">
                                                             </p>
                                                         </div>
                                                         <a href="javascript:void(0)" data-bs-toggle="modal"
                                                             class="email-whatsapp"
                                                             data-bs-target="#email_otp_popup_Modal">Don't have a
                                                             WhatsApp
                                                     ...
                                                     <div id="step-otp" style="display: none;">
                                                         ...
                                                         <a href="javascript:void(0)" data-bs-toggle="modal"
                                                             class="email-whatsapp"
                                                             data-bs-target="#email_otp_popup_Modal">Can't log in? Use
                                                             your
                                                             Email Address</a>
                                                         ...
                                                         <div class="text-center mt-3">
                                                             ...
                                                             <button type="button"
                                                                 ...
                                                                 onclick="goToOtpVerification('2')">Verify
                                                                 Number</button>
                                                         </div>
                                                     </div>
                                 ...
                                 <div class="modal modal-mobile-bottom-otp otp-login-form-modal"
                                     id="email_otp_popup_Modal" tabindex="-1" aria-labelledby="otpLabel"
                                     aria-hidden="true">
                                     <div
                                         class="modal-dialog modal-dialog-bottom-otp user-modal-dialog modal-dialog-centered">
                                         <div class="modal-content details-modal-content">
                                             <div class="modal-header details-header">
                                                 <h5 class="modal-title w-100" id="email_modalStepTitle">Log in or
                                                     Sign Up
                                                 </h5>
                                                 {{-- <button type="button" class="close closeBtn" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
                                             ...
                                             <div class="modal-body">
                                                 <div id="email_refresh_otp_div">
                                                     <input type="hidden" name="email_session_otp"
                                                         id="email_session_otp"
                                                         value= "{{ session('email-login-otp') }}">
                                                 </div>
                                                 <form class="form-horizontal details-form" id="emailOtpForm"
                                                     method="POST"
                                                     action="{{ route('home.user-email-otp-login') }}">
                                                     @csrf
                                                     ...
                                                     <div id="email-step-phone">
                                                         <div class="form-group mb-2">
                                                             ...
                                                             <input type="text" class="input-field"
                                                                 name="email_email" id="email_email"
                                                                 placeholder="Email Address">
                                                             <p id="email_email_error"
                                                                 style="display:none;color:red;"></p>
                                                         </div>
                                                         <a href="javascript:void(0)" data-bs-toggle="modal"
                                                             class="email-whatsapp"
                                                             data-bs-target="#otp_popup_Modal">Can't
                                                     ...
                                                     <div id="email-step-otp" style="display: none;">
                                                         <label id="mobilename-label">Please enter the
                                                             <strong>OTP</strong>
                                                             that was sent to:<br>
                                                     ...
                                                     <div id="email-step-details" style="display: none;">
                                                         ...
                                                         <div class="form-group mt-3">
                                                             <input type="text" class="form-control"
                                                                 ...
                                                                 placeholder="Full Name">
                                                             <p id="email_name_error" style="display:none;color:red;">
                                                             </p>
                                                         </div>
                                                         <div class="form-group mt-3">
                                                             <input type="tel" class="form-control"
                                                                 id="email_mobile" name="email_mobile"
                                                                 placeholder="Phone Number"
                                                                 onkeypress="return validateNumber(event)">
                                                             <p id="email_mobile_error"
                                                         ...
                                                         <div class="text-center mt-3">
                                                             ...
                                                             <button type="button"
                                                                 ...
                                                                 onclick="email_goToOtpVerification('3')">All
                                                                 Done</button>
                                                         </div>
