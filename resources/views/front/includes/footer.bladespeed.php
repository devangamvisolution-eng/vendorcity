        ...
        <a href="https://web.whatsapp.com/send?phone=9710568363677" target="_blank"><i class="fab fa-whatsapp"></i></a>
                                     ...
                                     <div class="container">
                                         ...
                                         <div class="service-areas-footer ">
                                             ...
                                             <div class="d-flex flex-wrap">
                                                 @foreach ($services_footer as $service)
                                                     @php
                                                         $subservices_footer = DB::table('subservices')
                                         ...
                                         <img loading="lazy" class="mb25 footer-logo" width="200" height="60"
                ...
                <li class="list-inline-item bg-white">
                  <select class="selectpicker show-tick">
                    ...
                    <option>Turkey</option>
                                 ...
                                 <!-- Wrapper End -->
                                 <script src="{{ asset('public/site/js/jquery-3.6.4.min.js') }}" defer></script>
                                 ...
                                 <script>
                                     ...
                                     function myFunction() {
                                         var dropdown = document.getElementById("myDropdownnew");
                                         var template = document.getElementById("mega-menu-template");
                                         if (template && !document.getElementById("rendered-mega-menu")) {
