                                    ...
                                    <div class="details">
                                        <a
                                            href="{{ route('front.subservices', ['city' => session('search_city_name'), 'page_url' => 'moving']) }}"><img
                                                ...
                                                alt="Moving service icon â€“ Vendorscity relocation experts" width="60"
                                                height="60"></a>
                                    </div>
                                </div>
                                <div class="details">
                                    ...
                                    <div class="details">
                                        <a
                                            href="{{ route('front.subservices', ['city' => session('search_city_name'), 'page_url' => 'handyman-maintainence']) }}"><img
                                                ...
                                                alt="Handyman service icon â€“ Vendorscity maintenance experts" width="60"
                                                height="60"></a>
                                    </div>
                                </div>
                                <div class="details">
                                                ...
                                                <div class="listing-style1">
                                                    <div class="list-thumb bdrs12">
                                                        ...
                                                        <img loading="lazy"
                                                            ...
                                                            class="service_img" width="235" height="160">
                                                        </a>
                                                    </div>
                                                </div>
    ...
    <div class="container">
        ...
        <div class="row wow fadeInDown" data-wow-delay="400ms">
            <div class="col-xl-10 offset-xl-2">
                <div id="we-do-slider-combined" class="splide">
                    <div class="splide__track w-100">
                        <ul class="splide__list d-flex flex-md-row flex-column justify-content-between"
                            style="gap: 20px;">
                            <li class="splide__slide flex-fill m-0 p-0">
                                <div
                                    class="iconbox-style9 default-box-shadow1 bgc-white box-padding bdrs12 position-relative mb30 text-center text-sm-start h-100">
                                    <div
                                        class="thumb w90 mb25 mx-auto mx-sm-0 position-relative rounded-circle d-sm-none">
                                        <img loading="lazy"
                                            src="{{ asset('public/site/images/Homepage/search.png') }}"
                                            alt="Search services">
                                    </div>
                                    <img class="d-none d-sm-inline-block mb-3" loading="lazy"
                                        src="{{ asset('public/site/images/Homepage/search.png') }}"
                                        alt="Search services">
                                    <h4 class="iconbox-title mt20">Find your required service</h4>
                                    <p class="text mb-0">Choose from 50+ services, 100+ vendors, same-day slots, live
                                        support, easy booking</p>
                                </div>
                            </li>
                            <li class="splide__slide flex-fill m-0 p-0">
                                <div
                                    ...
                                    <div
                                        class="thumb w90 mb25 mx-auto mx-sm-0 position-relative rounded-circle d-sm-none">
                                        <img loading="lazy"
                                            src="{{ asset('public/site/images/Homepage/verified.png') }}"
                                            alt="Verified">
                                    </div>
                                    <img class="d-none d-sm-inline-block mb-3" loading="lazy"
                                        src="{{ asset('public/site/images/Homepage/verified.png') }}" alt="Verified">
                            ...
                            <li class="splide__slide flex-fill m-0 p-0">
                                <div
                                    ...
                                    <div
                                        class="thumb w90 mb25 mx-auto mx-sm-0 position-relative rounded-circle d-sm-none">
                                        <img loading="lazy"
                                            src="{{ asset('public/site/images/Homepage/relax.png') }}"
                                            alt="Relax">
                                    </div>
                                    <img class="d-none d-sm-inline-block mb-3" loading="lazy"
                                        src="{{ asset('public/site/images/Homepage/relax.png') }}" alt="Relax">
                                    <h4 class="iconbox-title mt20">Relax & Let Us Handle the Work</h4>
                                    <p class="text mb-0">100% satisfaction, referral rewards, no hidden fees, quality
                                        checks, and personalized services</p>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row align-items-md-center">
            ...
            <div class="col-lg-4 col-5 wow fadeInUp" data-wow-delay="300ms" style="text-align: right;">
                <img loading="lazy" class="w100" src="{{ asset('public/site/images/googlereview.png') }}"
                    alt="Graphic representation of Google reviews" style="max-width: 400px;" width="400"
                    height="100">
            </div>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        new Splide('#we-do-slider-combined', {
            destroy: true, // Desktop gets normal HTML grid
            breakpoints: {
                767: {
                    destroy: false, // Re-enable on mobile
                    type: 'slide',
                    perPage: 2,
                    gap: '1rem',
                    autoplay: false,
                    pagination: false,
                    arrows: false,
                    fixedWidth: '80%', // Make slides visible partially
                    focus: 0,
                },
            },
        }).mount();
...
<!-- Tabby Dynamic Modal Loader -->
<template id="tabby-modal-template">
    @include('front.includes.tabby_modal')
</template>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const loadTabbyModal = function() {
            if (!document.getElementById('tabby_info_modal')) {
                let template = document.getElementById('tabby-modal-template');
                if (template) {
        ...
        // Attach event listeners to any button that triggers Tabby modal
        const tabbyButtons = document.querySelectorAll('[data-bs-target="#tabby_info_modal"]');
        tabbyButtons.forEach(btn => {
            btn.addEventListener('mouseenter', loadTabbyModal, {
                once: true
            });
            btn.addEventListener('touchstart', loadTabbyModal, {
                once: true
            });
            btn.addEventListener('click', loadTabbyModal);
        });
    });
</script>
