...
<style>
    ...
    /* Nodes with high-contrast shadows */
    .step-icon-bg {
        width: 48px;
        height: 48px;
        background: white;
    ...
    .step-box.active .step-icon-bg {
        ...
        box-shadow: 0 10px 15px rgba(22, 66, 132, 0.3);
    }
    ...
    /* Information Card (The "Received" Box) */
    .status-detail-card {
        background: #f8fafc;
    ...
    .status-detail-card .text-part p {
        margin: 0;
        font-size: 14px;
        color: var(--text-muted);
        line-height: 1.4;
    ...
    .btn-close-tracker {
        ...
        font-weight: 700;
        margin-top: 25px;
        box-shadow: 0 4px 12px rgba(22, 66, 132, 0.2);
    }
</style>
<style>
    :root {
                ...
                <div class="classic-card">
                    ...
                    <ul class="detail-list">
                        <li class="mb-0 mt-0">
                            ...
                            <span class="detail-value text-uppercase">{{ $currentStatusText }}</span>
                        </li>
                        <li class="mb-0 mt-0">
