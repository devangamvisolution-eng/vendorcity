...
<div class="automobile_lists">
                    ...
                    <div class="column main-content">
                            ...
                            <div class="row mt25">
                                ...
                                <div class="col-xl-10 col-lg-10">
                                    ...
                                    <textarea name="additional_details" class="form-control " row="5" col="30" id="additional_details"
                                        placeholder="Additional Location Details"></textarea>
                                    ...
                                    <div class="radio-group radio-checked row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="button_weekly">
                                                <input type="radio" id="cleaning_once" name="where_is_car_parked"
                                                    value="Showroom" onclick="cleaning_change(this.value)" checked>
                                        ...
                                        <div class="col-md-4">
                                            <div class="button_weekly">
                                                <input type="radio" id="cleaning_weekly" name="where_is_car_parked"
                                                    value="Outdoor" onclick="cleaning_change(this.value)">
                                                <label for="cleaning_weekly" class="labelclass">
                                                    <p style="font-weight:1000; "><i
                                                            class="fa-regular fa-car-building"></i></p>
                                        ...
                                        <div class="col-md-4">
                                            <div class="button_weekly">
                                                <input type="radio" id="cleaning_multiple_times"
                                                    name="where_is_car_parked" value="Home"
                                                    onclick="cleaning_change(this.value)">
                                                <label for="cleaning_multiple_times" class="labelclass">
                                                    <p style="font-weight:1000; "><i class="fa-regular fa-house"></i>
                                                    </p>
                                        ...
                                        <p class="wicp_info"><i class="fa-regular fa-circle-info"></i> Please ensure
                                            enough space for inspection.If a deposit for a test drive is needed, please
                                            pay showroom in advance.</p>
                                        <!-- </div> -->
                                    ...
                                    <div class="col-xl-10 col-lg-10">
                                        <div class="radio-group radio-checked row">
                                            ...
                                            @foreach ($vehicles as $index => $data)
                                                <div class="col-md-3">
                                                    <div class="brand_div">
                                                        <input type="radio" id="{{ $data->name }}"
                                                            name="vehicle_make" value="{{ $data->id }}"
                                                            onclick="car_change(this.value)"
                                                            @if ($index == 0) checked @endif>
                                                        <label for="{{ $data->name }}" class="labelclass">
                                                            <img src="{{ asset('public/upload/vehicle/medium/' . $data->image) }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="button_weekly">
                                                    <input type="radio" id="others" name="vehicle_make"
                                                        value="0" onclick="car_change(this.value)">
                                                    <label for="others" class="labelclass">
                                                        <img src="{{ asset('public/site/images/car/search.jpg') }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row mt25 other_car_div" style="display:none;">
                                <label class="form-label fw500 dark-color">Select Vehicle Make</label>
                                <div class="col-xl-10 col-lg-10">
                                    <select name="other_vehicle_make" id="other_vehicle_make" class="form-select"
                                        onchange="other_car_change(this.value);">
                            ...
                            <div class="row mt25 model_div" style="">
                                ...
                                <div class="col-xl-10 col-lg-10">
                                    <span id="changeModel">
                                        <select name="other_vehicle_model" id="other_vehicle_model"
                                            class="form-select" onchange="showCategory(this.value);">
                            ...
                            <div class="col-xl-10 col-lg-10 mt25" id="category_replace" style="display:none;">
                                ...
                                <input name="category" type="text" class="form-control " id="category"
                                    placeholder="Category" val="" readonly>
                            </div>

                            <div class="row vdtitle mt25">
                                <div class="col-xl-10 col-lg-10">
                                    <h5 class="title mb-3 mt30">Slot Selection</h5>
                                    <p><i class="fa-regular fa-circle-info"></i> Select your preferred date & time, our
                                        time will reach out to you within 24 hours to confirm your date & time based on
                                        availability.</p>
                                    <hr>
                                </div>
                            </div>
                            <div class="row mt25 model_div" style="">
                                ...
                                <div class="col-xl-10 col-lg-10">
                                    <input type="date" name="inspection_date" id="inspection_date"
                                        class="form-control " id="" placeholder="Select Date">
                            ...
                            <div class="price-widget pt25 bdrs8 summary_div_price">
                                ...
                                <div class="d-flex align-items-center justify-content-between price_div">
                                    ...
                                    <span class="price">AED <span
                                            id="totalprice">{{ $package->price }}</span></span>
                                </div>
                                ...
                                <div class="d-grid mt25">
                                    ...
                                    <a class="ud-btn btn-thm" id="submit_btn"
                                        onclick="book_inspection();">Proceed</a>
                                </div>
                            </div>
                            {{-- <div class="freelancer-style1 service-single mb-0 bdrs8 summary_div_price">
                  <h4>Payment</h4>
                  <div class="wrapper d-flex align-items-center mt20">
                    ...
                    <div class="radio-element">
                      <div class="form-check d-flex align-items-center mb15">
                                    ...
                                    <div class="form-check d-flex align-items-center mb15">
                                        <input class="form-check-input" type="radio" name="payment_method"
                                            id="payment_type2" value="2" checked>
                    ...
                    <form class="form-horizontal details-form" id="bookemailOtpForm" method="POST"
                        ...
                        <div id="booknow-email-step-otp" style="display: none;">
                            ...
                            <div class="text-center mt-3">
                                ...
                                <button type="button"
                                    class="brds50 ud-btn btn-thm default-box-shadow2 detail-continue-btn"
                                    id="submit_button_email_book2"
                                    onclick="book_email_goToOtpVerification('2')">Verify Email</button>
                            </div>
                        </div>
                        ...
                        <div id="booknow-email-step-details" style="display: none;">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" id="book_email_area"
                                    name="book_email_area" placeholder="Area">
    ...
    <script>
        ...
        const footer = document.querySelector('.fixheightDiv');
    ...
    <script>
        $(document).ready(function() {
            $('input[name="payment_method"]').on('change', function() {
                ...
                $('#payment_hidden').val(selectedValue);
            });
        });
    </script>
