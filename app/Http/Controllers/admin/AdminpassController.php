...

{
    ...
    function lost_password(Request $request)
    {
        ...
        if ($request->action == 'lost_pass') {
            ...
            <body>
                <div class="wrapper" style="width: 100%;max-width:500px;margin:auto;
                    ...
                    <div class="email_wrapper" style="width:100%;margin-top: 18px;font-size: 16px;">
                        ...
                        <p><a class="btnlink" href="' . url('reset-password-vendor/' . $encrypted) . '" style=" background: #0040E6;color: #fff !important;text-decoration: none;width: 100%;display: block;padding: 9px 0;text-align: center;font-size: 16px;border-radius: 9px;">Reset Password</a></p>
                        <br>
                        <p>We&apos;re here to help if you need it, <a style="color: #555;" href="' . \App\Helpers\Helper::get_front_url('contact') . '">Contact Us</a> so we can help resolve your problem immediately.</p>
                    </div>
            ...
            Mail::send([], [], function ($message) use ($data, $to, $subject, $ccRecipients) {
