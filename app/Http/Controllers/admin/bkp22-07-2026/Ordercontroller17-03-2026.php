...
If your order is Cash on Delivery, please make the payment directly to the vendor upon service completion.</p>';
            ...
            $customer_html .= '<p>The assigned vendor will contact you shortly to coordinate the final service details and confirm the exact timing.</p>';
        }
        ...
        $this->success_whatsapp_message_vendorassign($vendor_id, $order_id);
 ...
 <style>
    ...
    function success_book_now_mail($user_id, $order_id)
    {
        ...
        <div class="wrapper" style="width: 100%;max-width:500px;margin:auto;
            ...
            <div class="email_wrapper" style="width:100%;margin-top: 18px;font-size: 16px;" >
                                <p><strong>Dear</strong>' . $user_data->name . ',</p>
