...
class SurveyOrdercontroller extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = DB::table('ci_orders')
            ...
            ->where('ci_orders.is_survey_order', 1)
        ...
        return view('admin.survey_order.list', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.survey_order.add', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('survey-orders.index')->with('success', 'Survey Order Added Successfully');
    }
    ...
    public function show($id)
    {
        ...
        if (!$order) {
            return redirect()->route('survey-orders.index')->with('error', 'Order not found');
        }
        ...
        return view('admin.survey_order.detail', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.survey_order.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('survey-orders.index')->with('success', 'Survey Order Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('survey-orders.index')->with('success', 'Survey Order Deleted Successfully');
    }
}
