...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $service->appicon_alt_tag = $request->appicon_alt_tag;
        ...
        if ($request->hasfile('image') != '') {
            ...
            $width = 1350;
            $height = 440;
            $img->resize($width, $height, function ($constraint) {})->save($destinationPath . '/' . $data['image']);
        ...
        if ($request->hasfile('banner') != '') {
            ...
            $width = 400;
            $height = 475;
            $img->resize($width, $height, function ($constraint) {})->save($destinationPath . '/' . $data['banner']);
        ...
        if ($request->hasfile('app_icon') != '') {
            ...
            $remove_space = str_replace(' ', '-', $app_icon->getClientOriginalName());
            $data['app_icon'] = time() . $remove_space;
            //$destinationPath = public_path('upload/service/large/');
            /* $img = Image::make($home_icon->path());
            $width=1350;
            $height=440;
            ...
            $destinationPath = public_path('upload/service/');
            $app_icon->move($destinationPath, $data['app_icon']);
            $app_icon = $data['app_icon'];
        } else {
            $app_icon = "";
        }
        $service->app_icon = $app_icon;
