...
class Cartcontroller extends Controller
{
    ...
    public function cart(){
        ...
        $data['meta_title'] = "Book Premium Salon & Spa Services at Home | VendorsCity";
        $data['meta_keyword'] = "";
        $data['meta_description'] = "Review your selected services and products in your VendorsCity cart. Proceed to checkout for a seamless and secure shopping experience.";
