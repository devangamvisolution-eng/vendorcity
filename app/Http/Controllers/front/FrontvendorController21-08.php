...
class FrontvendorController extends Controller
{
    ...
    // echo $interpolatedSql;
      ...
      $data['meta_title'] = "";
        $data['meta_keyword'] = "";
        $data['meta_description'] = "Discover a trusted network of vendors offering quality services and products. Find the right professionals for all your needs on VendorsCity!";
