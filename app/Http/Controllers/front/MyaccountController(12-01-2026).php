...
// echo"<pre>";print_r($request->all());echo"</pre>";exit;
        ...
        if($old_ci_order_item_data->how_often_do_you_need_cleaning == 'Once' ||                 $request->ci_subservice_id == 70 || $request->ci_subservice_id == 29 ||
         $request->ci_subservice_id == 71 || $request->ci_subservice_id == 72 ||
          ...
          $request->ci_subservice_id == 88){
            ...
            $this->whatsappmsg_tmp_reschedule_vc($arrOrderId);
