...
class checkoutcontroller extends Controller
{
    ...
    //  echo "<pre>";print_r($booking_date);echo"</pre>";
    //  echo "<pre>";print_r($monthName);echo"</pre>";
    ...
    if(session('coupan_data.coupan_apply_wallet') == 0){ 
        ...
        // echo "<pre>";print_r($coupon_discounted);echo"</pre>";
        // echo "<pre>";print_r($coupan_code_name);echo"</pre>";exit;
    ...
    function book_now_order(Request $request){
        ...
        if($isPaintingBookOrEnquiry != "get-quote" && $type_of_paintingInset =="Move in / Move Out Painting" 
         || $cleaingService !="" || 
...
public function vendor_mail_for_garden($package_inquiry_id){
 ...
 <style>
     ...
     public function success_mail_book_now(){
        ...
        // echo"<pre>";print_r($format_order_id);echo"</pre>";
...
<div class="wrapper" style="width: 100%;max-width:500px;margin:auto;
    ...
    <body>
     ...
     function thankyou_book_now(){
        ...
        $data['thank_order_data'] = DB::table('ci_orders')->where('order_id',$order_number)->first();
        $data['thank_ci_order_data'] = DB::table('ci_order_item')->where('order_id',$order_number)->first();
        $data['meta_title'] = "";
       $data['meta_keyword'] = "";
       $data['meta_description'] = "";
