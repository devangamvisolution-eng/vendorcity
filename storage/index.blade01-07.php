                        ...
                        <div class="col-md-4 col-lg-5 col-xl-5">
                            <div class="advance-search-field mb10-sm">
                                <form action="{{ url('search-package') }}" method="get" id="search_banner"
                                   ...
                                   <input type="hidden" name="search_city" value="17" id="search_city">
                                </form>
                            </div>
                                    ...
                                    @if ($city != '')
                                        @foreach ($city as $city_data)
                                            <option data-tokens="{{ $city_data->name }}"
                                                value="{{ $city_data->id }}" @if($city_data->id == 17){{ 'selected' }}@endif>{{ $city_data->name }}
                                            </option>
                                        @endforeach
                                    @endif
                                </select>
        ...
        <div class="row wow fadeInUp" data-wow-delay="00ms">
            <div class="col-lg-12">
                <div class="main-title2 mb30">
                    ...
                    <h3 class="offerServices">United Arab Emirates - <br/>Dubai, Abu Dhabi, Sharjah, Ras Al Khamiah, Ajman, Umm Al Quwain</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6">
                <div class="position-relative wow fadeInLeft pl50" data-wow-delay="300ms">
                    ...
                    <a href="{{ url('/become-vendor') }}" class="ud-btn btn-thm">Register Now</a>
                </div>
            </div>
            <div class="col-xl-6">
                <div class="position-relative mb30-lg">
...
let sortedNames = names.sort(); // Make sure `names` array is populated correctly before this line
