...
Route::get('/home-banners', [HomeControllerApi::class, 'getHomeBanners']);
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('/store-wooden-floor-polishing', [HomeControllerApi::class, 'storeWoodenFloorPolishingInquiry']);
